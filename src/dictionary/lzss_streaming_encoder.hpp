#ifndef MARC_DICTIONARY_LZSS_STREAMING_ENCODER_HPP
#define MARC_DICTIONARY_LZSS_STREAMING_ENCODER_HPP
...
class LzssStreamingEncoder final : public core::Transform {
public:
    LzssStreamingEncoder(LzssParameters parameters,
