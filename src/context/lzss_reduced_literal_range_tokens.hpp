#ifndef MARC_CONTEXT_LZSS_REDUCED_LITERAL_RANGE_TOKENS_HPP
#define MARC_CONTEXT_LZSS_REDUCED_LITERAL_RANGE_TOKENS_HPP

#include "context/lzss_contextual_range_decoder.hpp"

namespace marc::context::internal {

// Private dictionary 2/8 + context 1/8 + entropy 3/2 path only. These
...
[[nodiscard]] LzssContextualRangeDecodeResult
decode_lzss_reduced_literal_range_tokens(
    const entropy::internal::ContextualDynamicRangeDescriptor& descriptor,
    std::span<const std::byte> payload,
    const dictionary::internal::LzssParameters& parameters,
    const LzssFieldContextValidationContext& context,
