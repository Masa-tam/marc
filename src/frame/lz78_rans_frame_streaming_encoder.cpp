...
Lz78RansFrameStreamingEncoder::Lz78RansFrameStreamingEncoder(
...
core::ProcessResult Lz78RansFrameStreamingEncoder::fail(
...
bool Lz78RansFrameStreamingEncoder::prepare_frame() noexcept {
    ...
    const auto plan = plan_lz78_rans_frame(
        ...
        dictionary_staging_);
    if (plan.error != Lz78RansFrameValidationError::none) {
        switch (plan.error) {
        case Lz78RansFrameValidationError::input_size_mismatch:
        case Lz78RansFrameValidationError::unsupported_pipeline:
            preparation_error_ = core::ErrorCode::invalid_argument;
            break;
        case Lz78RansFrameValidationError::encoder_workspace_too_small:
        case Lz78RansFrameValidationError::dictionary_staging_too_small:
        case Lz78RansFrameValidationError::serialized_output_too_small:
            preparation_error_ = core::ErrorCode::out_of_memory;
            break;
        case Lz78RansFrameValidationError::workspace_limit:
        case Lz78RansFrameValidationError::invalid_dictionary_extent:
        case Lz78RansFrameValidationError::invalid_entropy_extent:
        case Lz78RansFrameValidationError::dictionary_encode_error:
        case Lz78RansFrameValidationError::entropy_encode_error:
        case Lz78RansFrameValidationError::header_error:
        case Lz78RansFrameValidationError::arithmetic_overflow:
    ...
    const auto encoded = encode_lz78_rans_frame(
        stream_, parameters_, limits_, frame_sequence_, input_committed_,
        frame_input_storage_.first(frame_input_size_), encoder_workspace_,
        dictionary_staging_,
        frame_encoded_storage_.first(plan.serialized_size));
    if (encoded.error != Lz78RansFrameValidationError::none) {
        return false;
    }
...
core::ProcessResult Lz78RansFrameStreamingEncoder::process(
