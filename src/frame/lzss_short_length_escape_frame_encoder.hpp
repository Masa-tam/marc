#ifndef MARC_FRAME_LZSS_SHORT_LENGTH_ESCAPE_FRAME_ENCODER_HPP
#define MARC_FRAME_LZSS_SHORT_LENGTH_ESCAPE_FRAME_ENCODER_HPP

#include "frame/lzss_short_match_frame_encoder.hpp"

namespace marc::frame::internal {

// Private complete-frame encoder for the exact 2/8 + 1/7 + 3/2 identity.
