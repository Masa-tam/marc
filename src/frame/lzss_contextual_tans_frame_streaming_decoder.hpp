#ifndef MARC_FRAME_LZSS_CONTEXTUAL_TANS_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZSS_CONTEXTUAL_TANS_FRAME_STREAMING_DECODER_HPP
...
private:
    ...
    LzssContextualTansFrameHeader frame_{};
