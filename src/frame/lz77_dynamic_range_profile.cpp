...
Lz77DynamicRangeProfileError make_lz77_dynamic_range_profile(
    ...
    if (core::validate_limits(limits) != core::LimitError::none
        || config.frame_size == 0) {
        return Lz77DynamicRangeProfileError::invalid_configuration;
    }
    ...
    if (config.original_size > limits.max_total_output_size
        ...
        return Lz77DynamicRangeProfileError::limit_exceeded;
    }
    ...
    if (validate_stream_header(stream, limits) != StreamHeaderError::none) {
        return Lz77DynamicRangeProfileError::unsupported;
    }

    const auto largest_frame = std::min<std::uint64_t>(
        config.original_size, config.frame_size);
    if (largest_frame == 0) {
        return Lz77DynamicRangeProfileError::none;
    }
    ...
    if (!core::checked_multiply(
        ...
        return Lz77DynamicRangeProfileError::arithmetic_overflow;
    }
...
core::ErrorCode lz77_dynamic_range_profile_error_code(
    const Lz77DynamicRangeProfileError error) noexcept {
    switch (error) {
    case Lz77DynamicRangeProfileError::none:
        return core::ErrorCode::none;
    case Lz77DynamicRangeProfileError::invalid_configuration:
        return core::ErrorCode::invalid_argument;
    case Lz77DynamicRangeProfileError::unsupported:
        return core::ErrorCode::unsupported;
    case Lz77DynamicRangeProfileError::limit_exceeded:
    case Lz77DynamicRangeProfileError::arithmetic_overflow:
