#ifndef MARC_FRAME_LZD_BLOCKED_HUFFMAN_FRAME_STREAMING_ENCODER_HPP
#define MARC_FRAME_LZD_BLOCKED_HUFFMAN_FRAME_STREAMING_ENCODER_HPP
...
inline constexpr std::size_t lzd_blocked_huffman_stream_prefix_size =
    stream_header_size + dictionary::internal::lzd_parameter_size;

class LzdBlockedHuffmanFrameStreamingEncoder final : public core::Transform {
public:
    LzdBlockedHuffmanFrameStreamingEncoder(
        StreamHeader stream, dictionary::internal::LzdParameters parameters,
...
private:
    ...
    std::array<std::byte, lzd_blocked_huffman_stream_prefix_size> prefix_{};
    std::size_t frame_input_size_{};
    std::size_t pending_size_{lzd_blocked_huffman_stream_prefix_size};
