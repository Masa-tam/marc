#ifndef MARC_FRAME_LZSS_TYPED_CONTEXT_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZSS_TYPED_CONTEXT_FRAME_STREAMING_DECODER_HPP
...
private:
    ...
    TypedContextFrameHeader frame_{};
