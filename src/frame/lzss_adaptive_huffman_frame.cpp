...
[[nodiscard]] LzssAdaptiveHuffmanFrameValidationResult plan_frame(
    const StreamHeader& stream,
    const dictionary::internal::LzssParameters& parameters,
    const core::DecoderLimits& limits,
...
template <bool UseHashChain>
[[nodiscard]] LzssAdaptiveHuffmanFrameValidationResult encode_frame(
    const StreamHeader& stream,
    const dictionary::internal::LzssParameters& parameters,
    const core::DecoderLimits& limits,
    const std::uint64_t sequence,
...
LzssAdaptiveHuffmanFrameValidationResult
encode_lzss_adaptive_huffman_frame_hash_chain(
    const StreamHeader& stream,
    const dictionary::internal::LzssParameters& parameters,
    const core::DecoderLimits& limits,
    const std::uint64_t sequence,
