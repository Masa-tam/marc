#ifndef MARC_FRAME_LZSS_TANS_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZSS_TANS_FRAME_STREAMING_DECODER_HPP
...
class LzssTansFrameStreamingDecoder final : public core::Transform {
public:
    LzssTansFrameStreamingDecoder(
...
private:
    ...
    std::array<std::byte, lzss_tans_stream_prefix_size> prefix_bytes_{};
