#ifndef MARC_FRAME_LZMW_TANS_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZMW_TANS_FRAME_STREAMING_DECODER_HPP
...
class LzmwTansFrameStreamingDecoder final : public core::Transform {
public:
    LzmwTansFrameStreamingDecoder(
...
private:
    ...
    std::array<std::byte, lzmw_tans_stream_prefix_size> prefix_bytes_{};
