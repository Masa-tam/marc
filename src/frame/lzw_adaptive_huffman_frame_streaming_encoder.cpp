...
LzwAdaptiveHuffmanFrameStreamingEncoder::
LzwAdaptiveHuffmanFrameStreamingEncoder(
...
core::ProcessResult LzwAdaptiveHuffmanFrameStreamingEncoder::fail(
...
bool LzwAdaptiveHuffmanFrameStreamingEncoder::prepare_frame() noexcept {
    ...
    const auto plan = plan_lzw_adaptive_huffman_frame(
        ...
        dictionary_staging_);
    if (plan.error != LzwAdaptiveHuffmanFrameValidationError::none) {
        switch (plan.error) {
        case LzwAdaptiveHuffmanFrameValidationError::input_size_mismatch:
        case LzwAdaptiveHuffmanFrameValidationError::unsupported_pipeline:
            preparation_error_ = core::ErrorCode::invalid_argument;
            break;
        case LzwAdaptiveHuffmanFrameValidationError::
        ...
        case LzwAdaptiveHuffmanFrameValidationError::
            ...
            break;
        case LzwAdaptiveHuffmanFrameValidationError::workspace_limit:
        case LzwAdaptiveHuffmanFrameValidationError::
            invalid_dictionary_extent:
        case LzwAdaptiveHuffmanFrameValidationError::invalid_entropy_extent:
        case LzwAdaptiveHuffmanFrameValidationError::dictionary_encode_error:
        case LzwAdaptiveHuffmanFrameValidationError::entropy_encode_error:
        case LzwAdaptiveHuffmanFrameValidationError::header_error:
        case LzwAdaptiveHuffmanFrameValidationError::arithmetic_overflow:
    ...
    const auto encoded = encode_lzw_adaptive_huffman_frame(
        stream_, parameters_, limits_, frame_sequence_, input_committed_,
        frame_input_storage_.first(frame_input_size_), encoder_workspace_,
        dictionary_staging_,
        frame_encoded_storage_.first(plan.serialized_size));
    if (encoded.error != LzwAdaptiveHuffmanFrameValidationError::none) {
        return false;
    }
...
core::ProcessResult LzwAdaptiveHuffmanFrameStreamingEncoder::process(
