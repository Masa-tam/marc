#ifndef MARC_FRAME_LZSS_CONTEXTUAL_BLOCKED_HUFFMAN_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZSS_CONTEXTUAL_BLOCKED_HUFFMAN_FRAME_STREAMING_DECODER_HPP
...
private:
    ...
    LzssContextualBlockedHuffmanFrameHeader frame_{};
