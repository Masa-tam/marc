#ifndef MARC_FRAME_LZW_RANS_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZW_RANS_FRAME_STREAMING_DECODER_HPP
...
class LzwRansFrameStreamingDecoder final : public core::Transform {
public:
    LzwRansFrameStreamingDecoder(
        core::DecoderLimits limits,
        std::span<std::byte> frame_encoded_storage,
        std::span<entropy::internal::RansBlockView> frame_views,
...
private:
    ...
    std::span<entropy::internal::RansBlockView> frame_views_{};
    ...
    std::array<std::byte, lzw_rans_stream_prefix_size> prefix_bytes_{};
