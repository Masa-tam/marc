#ifndef MARC_FRAME_LZMW_ADAPTIVE_HUFFMAN_FRAME_STREAMING_ENCODER_HPP
#define MARC_FRAME_LZMW_ADAPTIVE_HUFFMAN_FRAME_STREAMING_ENCODER_HPP
...
inline constexpr std::size_t lzmw_adaptive_huffman_stream_prefix_size =
    stream_header_size + dictionary::internal::lzmw_parameter_size;

class LzmwAdaptiveHuffmanFrameStreamingEncoder final
...
private:
    ...
    std::span<dictionary::internal::LzmwEncoderEntry> encoder_workspace_{};
    std::array<std::byte, lzmw_adaptive_huffman_stream_prefix_size> prefix_{};
    std::size_t frame_input_size_{};
    std::size_t pending_size_{lzmw_adaptive_huffman_stream_prefix_size};
