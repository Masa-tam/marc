...
Lz77DynamicRangeFrameStreamingEncoder::
Lz77DynamicRangeFrameStreamingEncoder(
...
core::ProcessResult Lz77DynamicRangeFrameStreamingEncoder::fail(
...
bool Lz77DynamicRangeFrameStreamingEncoder::prepare_frame() noexcept {
    ...
    if (plan.error != Lz77DynamicRangeFrameValidationError::none) {
        switch (plan.error) {
        case Lz77DynamicRangeFrameValidationError::input_size_mismatch:
        case Lz77DynamicRangeFrameValidationError::unsupported_pipeline:
            preparation_error_ = core::ErrorCode::invalid_argument;
            break;
        case Lz77DynamicRangeFrameValidationError::
            dictionary_staging_too_small:
        case Lz77DynamicRangeFrameValidationError::
            serialized_output_too_small:
            preparation_error_ = core::ErrorCode::out_of_memory;
            break;
        case Lz77DynamicRangeFrameValidationError::workspace_limit:
        case Lz77DynamicRangeFrameValidationError::
            invalid_dictionary_extent:
        case Lz77DynamicRangeFrameValidationError::invalid_entropy_extent:
        case Lz77DynamicRangeFrameValidationError::dictionary_encode_error:
        case Lz77DynamicRangeFrameValidationError::entropy_encode_error:
        case Lz77DynamicRangeFrameValidationError::header_error:
        case Lz77DynamicRangeFrameValidationError::arithmetic_overflow:
    ...
    if (!core::checked_add(
        ...
        || !core::checked_add(
            aggregate_bytes,
            static_cast<std::uint64_t>(plan.serialized_size), aggregate_bytes)
    ...
    const auto encoded = encode_lz77_dynamic_range_frame(
        stream_, parameters_, limits_, frame_sequence_, input_committed_,
        frame_input_storage_.first(frame_input_size_), dictionary_staging_,
        frame_encoded_storage_.first(plan.serialized_size));
    if (encoded.error != Lz77DynamicRangeFrameValidationError::none) {
        return false;
    }
...
core::ProcessResult Lz77DynamicRangeFrameStreamingEncoder::process(
