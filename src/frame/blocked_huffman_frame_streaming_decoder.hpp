#ifndef MARC_FRAME_BLOCKED_HUFFMAN_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_BLOCKED_HUFFMAN_FRAME_STREAMING_DECODER_HPP
...
class BlockedHuffmanFrameStreamingDecoder final : public core::Transform {
public:
    BlockedHuffmanFrameStreamingDecoder(
