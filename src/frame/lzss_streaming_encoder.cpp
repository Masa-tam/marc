...
core::ProcessResult LzssFrameStreamingEncoder::fail(
    ...
    if (plan.error != LzssFrameCodecError::none) {
        if (plan.error == LzssFrameCodecError::input_size_mismatch)
            preparation_error_ = core::ErrorCode::invalid_argument;
                 ...
                 == dictionary::internal::LzssEncodeError::input_limit_exceeded
                 || plan.encode_error
...
core::ProcessResult LzssFrameStreamingEncoder::process(
