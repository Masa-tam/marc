#ifndef MARC_FRAME_LZSS_BLOCKED_HUFFMAN_STREAM_HPP
#define MARC_FRAME_LZSS_BLOCKED_HUFFMAN_STREAM_HPP
...
enum class LzssBlockedHuffmanStreamCodecError : std::uint8_t {
    none,
...
struct LzssBlockedHuffmanStreamCodecResult {
...
[[nodiscard]] LzssBlockedHuffmanStreamCodecResult
