...
Lz77FrameStreamingDecoder::Lz77FrameStreamingDecoder(
...
core::ProcessResult Lz77FrameStreamingDecoder::fail(
...
bool Lz77FrameStreamingDecoder::parse_collected_prefix() noexcept {
...
bool Lz77FrameStreamingDecoder::parse_collected_frame_header() noexcept {
...
bool Lz77FrameStreamingDecoder::decode_collected_frame() noexcept {
    const auto decoded = decode_lz77_frame(
    ...
    if (decoded.error != Lz77FrameCodecError::none) return false;
...
core::ProcessResult Lz77FrameStreamingDecoder::process(
    ...
    while (true) {
        ...
        if (state_ == State::collecting_prefix) {
            const auto needed = lz77_stream_prefix_size - header_collected_;
            ...
            if (header_collected_ != lz77_stream_prefix_size) {
