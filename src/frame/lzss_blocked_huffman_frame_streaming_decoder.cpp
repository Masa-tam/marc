...
core::ProcessResult LzssBlockedHuffmanFrameStreamingDecoder::fail(
...
bool LzssBlockedHuffmanFrameStreamingDecoder::parse_collected_prefix()
    noexcept {
...
bool LzssBlockedHuffmanFrameStreamingDecoder::
...
bool LzssBlockedHuffmanFrameStreamingDecoder::decode_collected_frame()
    noexcept {
    const auto decoded = decode_lzss_blocked_huffman_frame(
...
core::ProcessResult LzssBlockedHuffmanFrameStreamingDecoder::process(
    ...
    while (true) {
        ...
        if (state_ == State::collecting_prefix) {
            const auto needed = lzss_blocked_huffman_stream_prefix_size
                - header_collected_;
