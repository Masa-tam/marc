#ifndef MARC_FRAME_LZ78_RANS_FRAME_STREAMING_ENCODER_HPP
#define MARC_FRAME_LZ78_RANS_FRAME_STREAMING_ENCODER_HPP
...
inline constexpr std::size_t lz78_rans_stream_prefix_size =
    stream_header_size + dictionary::internal::lz78_parameter_size;

class Lz78RansFrameStreamingEncoder final : public core::Transform {
public:
    Lz78RansFrameStreamingEncoder(
        StreamHeader stream,
...
private:
    ...
    std::array<std::byte, lz78_rans_stream_prefix_size> prefix_{};
    std::size_t frame_input_size_{};
    std::size_t pending_size_{lz78_rans_stream_prefix_size};
