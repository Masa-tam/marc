#ifndef MARC_FRAME_LZ78_BLOCKED_HUFFMAN_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZ78_BLOCKED_HUFFMAN_FRAME_STREAMING_DECODER_HPP
...
class Lz78BlockedHuffmanFrameStreamingDecoder final
...
private:
    ...
    std::array<std::byte, lz78_blocked_huffman_stream_prefix_size>
        prefix_bytes_{};
