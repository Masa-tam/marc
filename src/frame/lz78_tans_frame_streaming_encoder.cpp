...
Lz78TansFrameStreamingEncoder::Lz78TansFrameStreamingEncoder(
...
core::ProcessResult Lz78TansFrameStreamingEncoder::fail(
...
bool Lz78TansFrameStreamingEncoder::prepare_frame() noexcept {
    ...
    const auto plan = plan_lz78_tans_frame(
        ...
        dictionary_staging_);
    if (plan.error != Lz78TansFrameValidationError::none) {
        switch (plan.error) {
        case Lz78TansFrameValidationError::input_size_mismatch:
        case Lz78TansFrameValidationError::unsupported_pipeline:
            preparation_error_ = core::ErrorCode::invalid_argument;
            break;
        case Lz78TansFrameValidationError::encoder_workspace_too_small:
        case Lz78TansFrameValidationError::dictionary_staging_too_small:
        case Lz78TansFrameValidationError::serialized_output_too_small:
            preparation_error_ = core::ErrorCode::out_of_memory;
            break;
        case Lz78TansFrameValidationError::workspace_limit:
        case Lz78TansFrameValidationError::invalid_dictionary_extent:
        case Lz78TansFrameValidationError::invalid_entropy_extent:
        case Lz78TansFrameValidationError::dictionary_encode_error:
        case Lz78TansFrameValidationError::entropy_encode_error:
        case Lz78TansFrameValidationError::header_error:
        case Lz78TansFrameValidationError::arithmetic_overflow:
    ...
    const auto encoded = encode_lz78_tans_frame(
        stream_, parameters_, limits_, frame_sequence_, input_committed_,
        frame_input_storage_.first(frame_input_size_), encoder_workspace_,
        dictionary_staging_,
        frame_encoded_storage_.first(plan.serialized_size));
    if (encoded.error != Lz78TansFrameValidationError::none) {
        return false;
    }
...
core::ProcessResult Lz78TansFrameStreamingEncoder::process(
