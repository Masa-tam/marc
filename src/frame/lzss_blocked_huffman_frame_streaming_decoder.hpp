#ifndef MARC_FRAME_LZSS_BLOCKED_HUFFMAN_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZSS_BLOCKED_HUFFMAN_FRAME_STREAMING_DECODER_HPP
...
class LzssBlockedHuffmanFrameStreamingDecoder final
    : public core::Transform {
public:
    LzssBlockedHuffmanFrameStreamingDecoder(
...
private:
    ...
    std::array<std::byte, lzss_blocked_huffman_stream_prefix_size>
        prefix_bytes_{};
