...
[[nodiscard]] LzssContextualRansCompactFrameEncodeResult fail_overlap(
    LzssContextualRansCompactFrameEncodeResult result,
...
LzssContextualRansCompactFrameEncodeResult
plan_lzss_contextual_rans_compact_frame(
    ...
    if (validate_lzss_contextual_rans_compact_stream_header(stream, limits)
    ...
    result.header_error = validate_lzss_contextual_rans_compact_frame_header(
...
encode_lzss_contextual_rans_compact_frame(
    ...
    const LzssContextualRansFrameValidationContext frame_context{
        stream, limits, sequence, output_already_committed};
    result.header_error = serialize_lzss_contextual_rans_compact_frame_header(
        header, frame_context,
