#ifndef MARC_FRAME_LZMW_RANS_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZMW_RANS_FRAME_STREAMING_DECODER_HPP
...
class LzmwRansFrameStreamingDecoder final : public core::Transform {
public:
    LzmwRansFrameStreamingDecoder(
...
private:
    ...
    std::array<std::byte, lzmw_rans_stream_prefix_size> prefix_bytes_{};
