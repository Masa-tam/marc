...
core::ProcessResult Lz77AdaptiveHuffmanFrameStreamingDecoder::fail(
...
bool Lz77AdaptiveHuffmanFrameStreamingDecoder::parse_collected_prefix()
    noexcept {
...
bool Lz77AdaptiveHuffmanFrameStreamingDecoder::
...
bool Lz77AdaptiveHuffmanFrameStreamingDecoder::decode_collected_frame()
    noexcept {
    const auto decoded = decode_lz77_adaptive_huffman_frame_to_staging(
...
core::ProcessResult Lz77AdaptiveHuffmanFrameStreamingDecoder::process(
    ...
    while (true) {
        ...
        if (state_ == State::collecting_prefix) {
            const auto needed = lz77_adaptive_huffman_stream_prefix_size
                - header_collected_;
