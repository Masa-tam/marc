#ifndef MARC_FRAME_LZW_STREAMING_ENCODER_HPP
#define MARC_FRAME_LZW_STREAMING_ENCODER_HPP
...
class LzwFrameStreamingEncoder final : public core::Transform {
public:
    LzwFrameStreamingEncoder(
...
private:
    ...
    std::span<dictionary::internal::LzwEncoderEntry> dictionary_workspace_{};
    std::array<std::byte, lzw_stream_prefix_size> prefix_{};
    std::size_t frame_input_size_{};
    std::size_t pending_size_{lzw_stream_prefix_size};
