#ifndef MARC_FRAME_LZSS_STREAMING_DECODER_HPP
#define MARC_FRAME_LZSS_STREAMING_DECODER_HPP
...
class LzssFrameStreamingDecoder final : public core::Transform {
public:
    LzssFrameStreamingDecoder(
...
private:
    ...
    std::array<std::byte, lzss_stream_prefix_size> prefix_bytes_{};
