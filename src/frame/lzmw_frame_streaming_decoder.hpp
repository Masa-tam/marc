#ifndef MARC_FRAME_LZMW_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZMW_FRAME_STREAMING_DECODER_HPP
...
class LzmwFrameStreamingDecoder final : public core::Transform {
public:
    LzmwFrameStreamingDecoder(
...
private:
    ...
    std::array<std::byte, lzmw_stream_prefix_size> prefix_bytes_{};
