#ifndef MARC_FRAME_TANS_FRAME_STREAMING_ENCODER_HPP
#define MARC_FRAME_TANS_FRAME_STREAMING_ENCODER_HPP
...
class TansFrameStreamingEncoder final : public core::Transform {
public:
    TansFrameStreamingEncoder(
