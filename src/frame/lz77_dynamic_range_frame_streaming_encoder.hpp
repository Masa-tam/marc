#ifndef MARC_FRAME_LZ77_DYNAMIC_RANGE_FRAME_STREAMING_ENCODER_HPP
#define MARC_FRAME_LZ77_DYNAMIC_RANGE_FRAME_STREAMING_ENCODER_HPP
...
inline constexpr std::size_t lz77_dynamic_range_stream_prefix_size =
    stream_header_size + dictionary::internal::lz77_parameter_size;

class Lz77DynamicRangeFrameStreamingEncoder final : public core::Transform {
public:
...
private:
    ...
    std::array<std::byte, lz77_dynamic_range_stream_prefix_size> prefix_{};
    std::size_t frame_input_size_{};
    std::size_t pending_size_{lz77_dynamic_range_stream_prefix_size};
