...
[[nodiscard]] LzmwTansFrameValidationResult validate_frame(
    ...
    if (validate_stream_header(stream, limits) != StreamHeaderError::none
        ...
        result.error = LzmwTansFrameValidationError::unsupported_pipeline;
        return result;
    }
    if (input.size() < frame_header_size) {
        result.error = LzmwTansFrameValidationError::truncated_frame;
        return result;
    }
    ...
    if (result.header_error != FrameHeaderError::none) {
        result.error = LzmwTansFrameValidationError::header_error;
        return result;
    }
    ...
    if (input.size() != result.serialized_size) {
        result.error = LzmwTansFrameValidationError::trailing_frame_bytes;
        return result;
    }
    ...
    if (result.dictionary_size == 0
        ...
        result.error = LzmwTansFrameValidationError::invalid_dictionary_extent;
        return result;
    }
    ...
    if (result.block_count != expected_blocks
        ...
        result.error = LzmwTansFrameValidationError::invalid_entropy_extent;
        return result;
    }
    ...
    if (workspace_bytes > limits.max_internal_buffered_bytes) {
        result.error = LzmwTansFrameValidationError::workspace_limit;
        return result;
    }
    ...
    if (controlled.error != entropy::internal::TansControllerError::none) {
        result.error = LzmwTansFrameValidationError::controller_error;
        return result;
    }
    ...
    for (std::size_t block = 0; block < result.block_count; ++block) {
        ...
        if (validated.error != entropy::internal::TansDecodeError::none) {
            ...
            result.error = LzmwTansFrameValidationError::entropy_decode_error;
            return result;
        }
    }
    ...
    for (std::size_t block = 0; block < result.block_count; ++block) {
        ...
        if (decoded.error != entropy::internal::TansDecodeError::none) {
            ...
            result.error = LzmwTansFrameValidationError::internal_error;
            return result;
        }
        dictionary_offset += view.descriptor.symbol_count;
    }
...
LzmwTansFrameValidationResult plan_lzmw_tans_frame(
    const StreamHeader& stream,
    const dictionary::internal::LzmwParameters& parameters,
    const core::DecoderLimits& limits,
    ...
    if (input.empty()
        ...
        result.error = LzmwTansFrameValidationError::input_size_mismatch;
        return result;
    }
    ...
    if (dictionary_plan.error != dictionary::internal::LzmwEncodeError::none) {
        result.error = LzmwTansFrameValidationError::dictionary_encode_error;
        return result;
    }
    ...
    if (dictionary_encoded.error
        ...
        result.error = dictionary_encoded.error
                == dictionary::internal::LzmwEncodeError::none
            ? LzmwTansFrameValidationError::internal_error
            : LzmwTansFrameValidationError::dictionary_encode_error;
        return result;
    }
    ...
    if (block_count_u64 > limits.max_blocks_per_frame
        ...
        result.error = LzmwTansFrameValidationError::entropy_encode_error;
        return result;
    }
    ...
    for (std::size_t block = 0; block < result.block_count; ++block) {
        ...
        if (entropy_plan.error != entropy::internal::TansEncodeError::none) {
            result.block_index = block;
            result.error = LzmwTansFrameValidationError::entropy_encode_error;
            return result;
        }
    ...
    if (result.header_error != FrameHeaderError::none) {
        result.error = result.header_error
            ...
            : LzmwTansFrameValidationError::header_error;
        return result;
    }
    if (!core::checked_add(
...
LzmwTansFrameValidationResult encode_lzmw_tans_frame(
    const StreamHeader& stream,
    const dictionary::internal::LzmwParameters& parameters,
    const core::DecoderLimits& limits,
    const std::uint64_t sequence,
