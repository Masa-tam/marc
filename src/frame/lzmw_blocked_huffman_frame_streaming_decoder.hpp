#ifndef MARC_FRAME_LZMW_BLOCKED_HUFFMAN_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZMW_BLOCKED_HUFFMAN_FRAME_STREAMING_DECODER_HPP
...
class LzmwBlockedHuffmanFrameStreamingDecoder final : public core::Transform {
public:
...
private:
    ...
    std::array<std::byte, lzmw_blocked_huffman_stream_prefix_size>
        prefix_bytes_{};
