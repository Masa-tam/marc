...
inline constexpr std::uint64_t max_raw_frame_size = UINT64_C(1) << 21;
...
[[nodiscard]] Lz78DynamicRangeFrameValidationResult validate_frame(
    ...
    Lz78DynamicRangeFrameValidationResult result{};
    ...
    if (input.size() < frame_header_size) {
        result.error = Lz78DynamicRangeFrameValidationError::truncated_frame;
        return result;
    }
    ...
    if (result.header_error != FrameHeaderError::none) {
        result.error = Lz78DynamicRangeFrameValidationError::header_error;
        return result;
    }
    ...
    if (!core::checked_add(frame_header_size, result.descriptor_size,
        ...
        || !core::checked_add(result.serialized_size, result.payload_size,
                              result.serialized_size)) {
        result.error =
            Lz78DynamicRangeFrameValidationError::arithmetic_overflow;
        return result;
    }
    ...
    if (result.dictionary_size == 0
        ...
        result.error = Lz78DynamicRangeFrameValidationError::
    ...
    if (result.descriptor_error
        ...
        result.error = Lz78DynamicRangeFrameValidationError::descriptor_error;
        return result;
    }
    ...
    if (result.entropy_error
        ...
        result.error =
            Lz78DynamicRangeFrameValidationError::entropy_decode_error;
        return result;
    }
...
[[nodiscard]] bool reconstruct_validated_tokens(
    ...
    result.error =
        Lz78DynamicRangeFrameValidationError::dictionary_decode_error;
    return false;
}

} // namespace

Lz78DynamicRangeFrameValidationResult plan_lz78_dynamic_range_frame(
    const StreamHeader& stream,
    const dictionary::internal::Lz78Parameters& parameters,
    const core::DecoderLimits& limits,
    ...
    if (entropy_plan.error
        ...
        result.error =
            Lz78DynamicRangeFrameValidationError::entropy_encode_error;
        return result;
    }
...
Lz78DynamicRangeFrameValidationResult encode_lz78_dynamic_range_frame(
    const StreamHeader& stream,
    const dictionary::internal::Lz78Parameters& parameters,
    const core::DecoderLimits& limits,
    const std::uint64_t sequence,
    ...
    if (entropy_plan.error
        ...
        result.entropy_encode_error = entropy_plan.error;
        result.error = Lz78DynamicRangeFrameValidationError::internal_error;
        return result;
    }
...
Lz78DynamicRangeFrameValidationResult validate_lz78_dynamic_range_frame(
    const StreamHeader& stream,
    const dictionary::internal::Lz78Parameters& parameters,
    const core::DecoderLimits& limits,
    const std::uint64_t expected_sequence,
...
Lz78DynamicRangeFrameValidationResult
...
Lz78DynamicRangeFrameValidationResult decode_lz78_dynamic_range_frame(
    const StreamHeader& stream,
    const dictionary::internal::Lz78Parameters& parameters,
    const core::DecoderLimits& limits,
    const std::uint64_t expected_sequence,
