...
Lz78FrameStreamingDecoder::Lz78FrameStreamingDecoder(
...
core::ProcessResult Lz78FrameStreamingDecoder::fail(
...
bool Lz78FrameStreamingDecoder::parse_collected_prefix() noexcept {
...
bool Lz78FrameStreamingDecoder::parse_collected_frame_header() noexcept {
...
bool Lz78FrameStreamingDecoder::decode_collected_frame() noexcept {
    const auto decoded = decode_lz78_frame(
    ...
    if (decoded.error != Lz78FrameCodecError::none) return false;
...
core::ProcessResult Lz78FrameStreamingDecoder::process(
    ...
    while (true) {
        ...
        if (state_ == State::collecting_prefix) {
            const auto needed = lz78_stream_prefix_size - header_collected_;
            ...
            if (header_collected_ != lz78_stream_prefix_size) {
