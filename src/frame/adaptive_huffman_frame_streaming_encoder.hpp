#ifndef MARC_FRAME_ADAPTIVE_HUFFMAN_FRAME_STREAMING_ENCODER_HPP
#define MARC_FRAME_ADAPTIVE_HUFFMAN_FRAME_STREAMING_ENCODER_HPP
...
class AdaptiveHuffmanFrameStreamingEncoder final : public core::Transform {
public:
    AdaptiveHuffmanFrameStreamingEncoder(
...
private:
    ...
    [[nodiscard]] core::ProcessResult fail(
        core::ErrorCode code, std::size_t input_consumed,
