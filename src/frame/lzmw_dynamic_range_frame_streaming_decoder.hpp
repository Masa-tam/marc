#ifndef MARC_FRAME_LZMW_DYNAMIC_RANGE_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZMW_DYNAMIC_RANGE_FRAME_STREAMING_DECODER_HPP
...
class LzmwDynamicRangeFrameStreamingDecoder final : public core::Transform {
public:
...
private:
    ...
    std::array<std::byte, lzmw_dynamic_range_stream_prefix_size> prefix_bytes_{};
