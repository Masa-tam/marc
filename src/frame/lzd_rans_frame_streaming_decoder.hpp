#ifndef MARC_FRAME_LZD_RANS_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZD_RANS_FRAME_STREAMING_DECODER_HPP
...
class LzdRansFrameStreamingDecoder final : public core::Transform {
public:
    LzdRansFrameStreamingDecoder(
...
private:
    ...
    std::array<std::byte, lzd_rans_stream_prefix_size> prefix_bytes_{};
