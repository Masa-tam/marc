#ifndef MARC_FRAME_LZSS_ADAPTIVE_HUFFMAN_FRAME_STREAMING_ENCODER_HPP
#define MARC_FRAME_LZSS_ADAPTIVE_HUFFMAN_FRAME_STREAMING_ENCODER_HPP
...
class LzssAdaptiveHuffmanFrameStreamingEncoder final
...
private:
    ...
    std::size_t pending_size_{lzss_adaptive_huffman_stream_prefix_size};
