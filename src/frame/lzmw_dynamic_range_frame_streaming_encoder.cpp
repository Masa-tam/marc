...
core::ProcessResult LzmwDynamicRangeFrameStreamingEncoder::fail(
...
bool LzmwDynamicRangeFrameStreamingEncoder::prepare_frame() noexcept {
    ...
    const auto plan = plan_lzmw_dynamic_range_frame(
        ...
        dictionary_staging_);
    if (plan.error != LzmwDynamicRangeFrameValidationError::none) {
        switch (plan.error) {
        case LzmwDynamicRangeFrameValidationError::input_size_mismatch:
        case LzmwDynamicRangeFrameValidationError::unsupported_pipeline:
            preparation_error_ = core::ErrorCode::invalid_argument;
            break;
        case LzmwDynamicRangeFrameValidationError::
        ...
        case LzmwDynamicRangeFrameValidationError::
            ...
            break;
        case LzmwDynamicRangeFrameValidationError::workspace_limit:
        case LzmwDynamicRangeFrameValidationError::
            invalid_dictionary_extent:
        case LzmwDynamicRangeFrameValidationError::invalid_entropy_extent:
        case LzmwDynamicRangeFrameValidationError::dictionary_encode_error:
        case LzmwDynamicRangeFrameValidationError::entropy_encode_error:
        case LzmwDynamicRangeFrameValidationError::header_error:
        case LzmwDynamicRangeFrameValidationError::arithmetic_overflow:
    ...
    const auto encoded = encode_lzmw_dynamic_range_frame(
        stream_, parameters_, limits_, frame_sequence_, input_committed_,
        frame_input_storage_.first(frame_input_size_), encoder_workspace_,
        dictionary_staging_,
        frame_encoded_storage_.first(plan.serialized_size));
    if (encoded.error != LzmwDynamicRangeFrameValidationError::none) {
        return false;
    }
...
core::ProcessResult LzmwDynamicRangeFrameStreamingEncoder::process(
