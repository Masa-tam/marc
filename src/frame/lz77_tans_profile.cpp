...
Lz77TansProfileError make_lz77_tans_profile(
    ...
    if (core::validate_limits(limits) != core::LimitError::none
        ...
        return Lz77TansProfileError::invalid_configuration;
    }
    ...
    if (config.original_size > limits.max_total_output_size
        ...
        return Lz77TansProfileError::limit_exceeded;
    }
    ...
    if (!core::checked_multiply(
            ...
            dictionary_bytes)) {
        return Lz77TansProfileError::arithmetic_overflow;
    }
...
Lz77TansProfileError calculate_lz77_tans_decoder_workspace(
    const core::DecoderLimits& limits,
...
core::ErrorCode lz77_tans_profile_error_code(
    const Lz77TansProfileError error) noexcept {
    switch (error) {
    case Lz77TansProfileError::none:
        return core::ErrorCode::none;
    case Lz77TansProfileError::invalid_configuration:
        return core::ErrorCode::invalid_argument;
    case Lz77TansProfileError::unsupported:
        return core::ErrorCode::unsupported;
    case Lz77TansProfileError::limit_exceeded:
    case Lz77TansProfileError::arithmetic_overflow:
