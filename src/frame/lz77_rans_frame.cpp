...
[[nodiscard]] Lz77RansFrameValidationResult validate_frame(
    ...
    if (validate_stream_header(stream, limits) != StreamHeaderError::none
        ...
        result.error = Lz77RansFrameValidationError::unsupported_pipeline;
        return result;
    }
    if (input.size() < frame_header_size) {
        result.error = Lz77RansFrameValidationError::truncated_frame;
        return result;
    }
    ...
    if (result.header_error != FrameHeaderError::none) {
        result.error = Lz77RansFrameValidationError::header_error;
        return result;
    }
    ...
    if (!core::checked_add(frame_header_size, result.descriptor_size,
        ...
        || !core::checked_add(result.serialized_size, result.payload_size,
                              result.serialized_size)) {
        result.error = Lz77RansFrameValidationError::arithmetic_overflow;
        return result;
    }
    ...
    if (input.size() != result.serialized_size) {
        result.error = Lz77RansFrameValidationError::trailing_frame_bytes;
        return result;
    }
    ...
    if (result.dictionary_size == 0
        ...
        result.error =
            Lz77RansFrameValidationError::invalid_dictionary_extent;
        return result;
    }
    ...
    if (result.block_count != expected_blocks
        ...
        result.error = Lz77RansFrameValidationError::invalid_entropy_extent;
        return result;
    }
    if (views.size() < result.block_count) {
        result.error = Lz77RansFrameValidationError::views_too_small;
        return result;
    }
    if (dictionary_staging.size() < result.dictionary_size) {
        result.error =
            Lz77RansFrameValidationError::dictionary_staging_too_small;
        return result;
    }
    ...
    if (workspace_bytes > limits.max_internal_buffered_bytes) {
        result.error = Lz77RansFrameValidationError::workspace_limit;
        return result;
    }
    ...
    if (controlled.error != entropy::internal::RansControllerError::none) {
        result.error = Lz77RansFrameValidationError::controller_error;
        return result;
    }
...
Lz77RansFrameValidationResult plan_lz77_rans_frame(
    const StreamHeader& stream,
    const dictionary::internal::Lz77Parameters& parameters,
    const core::DecoderLimits& limits,
    ...
    if (input.empty()
        ...
        result.error = Lz77RansFrameValidationError::input_size_mismatch;
        return result;
    }
    ...
    if (dictionary_plan.error
        ...
        result.error =
            Lz77RansFrameValidationError::dictionary_encode_error;
        return result;
    }
    if (result.dictionary_size == 0
    ...
    if (block_count_u64 > limits.max_blocks_per_frame
        ...
        result.error = Lz77RansFrameValidationError::entropy_encode_error;
        return result;
    }
    ...
    if (result.header_error != FrameHeaderError::none) {
        result.error =
            ...
            : Lz77RansFrameValidationError::header_error;
        return result;
    }
    if (!core::checked_add(
            frame_header_size, result.descriptor_size,
