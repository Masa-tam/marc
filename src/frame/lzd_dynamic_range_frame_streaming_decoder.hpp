#ifndef MARC_FRAME_LZD_DYNAMIC_RANGE_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZD_DYNAMIC_RANGE_FRAME_STREAMING_DECODER_HPP
...
class LzdDynamicRangeFrameStreamingDecoder final : public core::Transform {
public:
...
private:
    ...
    std::span<dictionary::internal::LzdPhraseEntry> phrase_workspace_{};
    std::span<std::uint32_t> expansion_workspace_{};
    std::array<std::byte, lzd_dynamic_range_stream_prefix_size> prefix_bytes_{};
