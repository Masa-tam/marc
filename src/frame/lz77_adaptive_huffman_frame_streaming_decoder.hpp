#ifndef MARC_FRAME_LZ77_ADAPTIVE_HUFFMAN_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZ77_ADAPTIVE_HUFFMAN_FRAME_STREAMING_DECODER_HPP
...
class Lz77AdaptiveHuffmanFrameStreamingDecoder final
    : public core::Transform {
public:
    Lz77AdaptiveHuffmanFrameStreamingDecoder(
...
private:
    ...
    std::array<std::byte, lz77_adaptive_huffman_stream_prefix_size>
        prefix_bytes_{};
