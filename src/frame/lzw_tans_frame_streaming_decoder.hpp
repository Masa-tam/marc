#ifndef MARC_FRAME_LZW_TANS_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZW_TANS_FRAME_STREAMING_DECODER_HPP
...
class LzwTansFrameStreamingDecoder final : public core::Transform {
public:
    LzwTansFrameStreamingDecoder(
...
private:
    ...
    std::array<std::byte, lzw_tans_stream_prefix_size> prefix_bytes_{};
