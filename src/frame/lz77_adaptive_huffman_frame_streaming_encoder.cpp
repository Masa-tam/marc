...
Lz77AdaptiveHuffmanFrameStreamingEncoder::
Lz77AdaptiveHuffmanFrameStreamingEncoder(
...
core::ProcessResult Lz77AdaptiveHuffmanFrameStreamingEncoder::fail(
...
bool Lz77AdaptiveHuffmanFrameStreamingEncoder::prepare_frame() noexcept {
    ...
    if (plan.error
        ...
        switch (plan.error) {
        case Lz77AdaptiveHuffmanFrameValidationError::input_size_mismatch:
        case Lz77AdaptiveHuffmanFrameValidationError::unsupported_pipeline:
            preparation_error_ = core::ErrorCode::invalid_argument;
            break;
        case Lz77AdaptiveHuffmanFrameValidationError::
            dictionary_staging_too_small:
        case Lz77AdaptiveHuffmanFrameValidationError::
            serialized_output_too_small:
            preparation_error_ = core::ErrorCode::out_of_memory;
            break;
        case Lz77AdaptiveHuffmanFrameValidationError::workspace_limit:
        case Lz77AdaptiveHuffmanFrameValidationError::
            invalid_dictionary_extent:
        case Lz77AdaptiveHuffmanFrameValidationError::invalid_entropy_extent:
        case Lz77AdaptiveHuffmanFrameValidationError::dictionary_encode_error:
        case Lz77AdaptiveHuffmanFrameValidationError::entropy_encode_error:
        case Lz77AdaptiveHuffmanFrameValidationError::header_error:
        case Lz77AdaptiveHuffmanFrameValidationError::arithmetic_overflow:
    ...
    const auto encoded = encode_lz77_adaptive_huffman_frame(
        stream_, parameters_, limits_, frame_sequence_, input_committed_,
        frame_input_storage_.first(frame_input_size_), dictionary_staging_,
...
core::ProcessResult Lz77AdaptiveHuffmanFrameStreamingEncoder::process(
