...
core::ProcessResult LzdDynamicRangeFrameStreamingEncoder::fail(
...
bool LzdDynamicRangeFrameStreamingEncoder::prepare_frame() noexcept {
    ...
    const auto plan = plan_lzd_dynamic_range_frame(
        ...
        dictionary_staging_);
    if (plan.error != LzdDynamicRangeFrameValidationError::none) {
        switch (plan.error) {
        case LzdDynamicRangeFrameValidationError::input_size_mismatch:
        case LzdDynamicRangeFrameValidationError::unsupported_pipeline:
            preparation_error_ = core::ErrorCode::invalid_argument;
            break;
        case LzdDynamicRangeFrameValidationError::
        ...
        case LzdDynamicRangeFrameValidationError::
            ...
            break;
        case LzdDynamicRangeFrameValidationError::workspace_limit:
        case LzdDynamicRangeFrameValidationError::
            invalid_dictionary_extent:
        case LzdDynamicRangeFrameValidationError::invalid_entropy_extent:
        case LzdDynamicRangeFrameValidationError::dictionary_encode_error:
        case LzdDynamicRangeFrameValidationError::entropy_encode_error:
        case LzdDynamicRangeFrameValidationError::header_error:
        case LzdDynamicRangeFrameValidationError::arithmetic_overflow:
    ...
    const auto encoded = encode_lzd_dynamic_range_frame(
        stream_, parameters_, limits_, frame_sequence_, input_committed_,
        frame_input_storage_.first(frame_input_size_), encoder_workspace_,
        dictionary_staging_,
        frame_encoded_storage_.first(plan.serialized_size));
    if (encoded.error != LzdDynamicRangeFrameValidationError::none) {
        return false;
    }
...
core::ProcessResult LzdDynamicRangeFrameStreamingEncoder::process(
