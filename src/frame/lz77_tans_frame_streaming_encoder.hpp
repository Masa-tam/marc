#ifndef MARC_FRAME_LZ77_TANS_FRAME_STREAMING_ENCODER_HPP
#define MARC_FRAME_LZ77_TANS_FRAME_STREAMING_ENCODER_HPP
...
inline constexpr std::size_t lz77_tans_stream_prefix_size =
    stream_header_size + dictionary::internal::lz77_parameter_size;

class Lz77TansFrameStreamingEncoder final : public core::Transform {
public:
    Lz77TansFrameStreamingEncoder(
        StreamHeader stream,
...
private:
    ...
    std::array<std::byte, lz77_tans_stream_prefix_size> prefix_{};
    std::size_t frame_input_size_{};
    std::size_t pending_size_{lz77_tans_stream_prefix_size};
