#ifndef MARC_FRAME_ADAPTIVE_HUFFMAN_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_ADAPTIVE_HUFFMAN_FRAME_STREAMING_DECODER_HPP
#include "core/status.hpp"
#include "frame/adaptive_huffman_frame.hpp"
#include <array>
namespace marc::frame {
class AdaptiveHuffmanFrameStreamingDecoder final : public core::Transform {
public:
  AdaptiveHuffmanFrameStreamingDecoder(core::DecoderLimits,
                                       std::span<std::byte>,
