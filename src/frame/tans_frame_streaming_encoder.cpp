...
TansFrameStreamingEncoder::TansFrameStreamingEncoder(
...
core::ProcessResult TansFrameStreamingEncoder::fail(
...
bool TansFrameStreamingEncoder::prepare_frame() noexcept {
    ...
    if (encoded.error != TansFrameCodecError::none) return false;
...
core::ProcessResult TansFrameStreamingEncoder::process(
