#ifndef MARC_FRAME_LZ78_TANS_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZ78_TANS_FRAME_STREAMING_DECODER_HPP
...
class Lz78TansFrameStreamingDecoder final : public core::Transform {
public:
    Lz78TansFrameStreamingDecoder(
...
private:
    ...
    std::span<dictionary::internal::Lz78PhraseEntry> phrase_workspace_{};
    std::array<std::byte, lz78_tans_stream_prefix_size> prefix_bytes_{};
