#ifndef MARC_FRAME_LZ77_TANS_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZ77_TANS_FRAME_STREAMING_DECODER_HPP
...
class Lz77TansFrameStreamingDecoder final : public core::Transform {
public:
    Lz77TansFrameStreamingDecoder(
...
private:
    ...
    std::array<std::byte, lz77_tans_stream_prefix_size> prefix_bytes_{};
