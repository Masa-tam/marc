...
[[nodiscard]] bool is_limit_failure(
    ...
    return result.error
        ...
        || (result.error
                == LzssContextualBlockedHuffmanFrameEncodeError::header_error
            && result.header_error
...
core::ProcessResult
LzssContextualBlockedHuffmanFrameStreamingEncoder::fail(
...
bool LzssContextualBlockedHuffmanFrameStreamingEncoder::output_is_disjoint(
...
bool LzssContextualBlockedHuffmanFrameStreamingEncoder::prepare_frame()
    ...
    const auto encoded =
        ...
        match_finder_strategy_, match_finder_workspace_,
...
core::ProcessResult
LzssContextualBlockedHuffmanFrameStreamingEncoder::process(
