...
[[nodiscard]] bool supported_pipeline(const StreamHeader& stream) noexcept {
    return stream.dictionary_algorithm == DictionaryAlgorithm::lz78
        ...
        && stream.frame_size <= (UINT32_C(1) << 21)
...
Lz78DynamicRangeFrameStreamingEncoder::
Lz78DynamicRangeFrameStreamingEncoder(
...
core::ProcessResult Lz78DynamicRangeFrameStreamingEncoder::fail(
...
bool Lz78DynamicRangeFrameStreamingEncoder::prepare_frame() noexcept {
    preparation_error_ = core::ErrorCode::internal_error;
    const auto plan = plan_lz78_dynamic_range_frame(
        ...
        dictionary_staging_);
    if (plan.error != Lz78DynamicRangeFrameValidationError::none) {
        switch (plan.error) {
        case Lz78DynamicRangeFrameValidationError::input_size_mismatch:
        case Lz78DynamicRangeFrameValidationError::unsupported_pipeline:
            preparation_error_ = core::ErrorCode::invalid_argument;
            break;
        case Lz78DynamicRangeFrameValidationError::
        ...
        case Lz78DynamicRangeFrameValidationError::
            ...
            break;
        case Lz78DynamicRangeFrameValidationError::workspace_limit:
        case Lz78DynamicRangeFrameValidationError::
            invalid_dictionary_extent:
        case Lz78DynamicRangeFrameValidationError::invalid_entropy_extent:
        case Lz78DynamicRangeFrameValidationError::dictionary_encode_error:
        case Lz78DynamicRangeFrameValidationError::entropy_encode_error:
        case Lz78DynamicRangeFrameValidationError::header_error:
        case Lz78DynamicRangeFrameValidationError::arithmetic_overflow:
    ...
    const auto encoded = encode_lz78_dynamic_range_frame(
        stream_, parameters_, limits_, frame_sequence_, input_committed_,
        frame_input_storage_.first(frame_input_size_), encoder_workspace_,
        dictionary_staging_,
        frame_encoded_storage_.first(plan.serialized_size));
    if (encoded.error != Lz78DynamicRangeFrameValidationError::none) {
        return false;
    }
...
core::ProcessResult Lz78DynamicRangeFrameStreamingEncoder::process(
