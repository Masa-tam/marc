...
core::ProcessResult LzssRansFrameStreamingEncoder::fail(
...
bool LzssRansFrameStreamingEncoder::prepare_frame() noexcept {
    ...
    if (plan.error != LzssRansFrameValidationError::none) {
        ...
        case LzssRansFrameValidationError::unsupported_pipeline:
            preparation_error_ = core::ErrorCode::invalid_argument;
            break;
        case LzssRansFrameValidationError::dictionary_staging_too_small:
        case LzssRansFrameValidationError::serialized_output_too_small:
...
core::ProcessResult LzssRansFrameStreamingEncoder::process(
