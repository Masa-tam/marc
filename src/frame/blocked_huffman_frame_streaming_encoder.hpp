#ifndef MARC_FRAME_BLOCKED_HUFFMAN_FRAME_STREAMING_ENCODER_HPP
#define MARC_FRAME_BLOCKED_HUFFMAN_FRAME_STREAMING_ENCODER_HPP
...
class BlockedHuffmanFrameStreamingEncoder final : public core::Transform {
public:
    BlockedHuffmanFrameStreamingEncoder(
        StreamHeader stream,
