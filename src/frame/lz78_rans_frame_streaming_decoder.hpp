#ifndef MARC_FRAME_LZ78_RANS_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZ78_RANS_FRAME_STREAMING_DECODER_HPP
...
class Lz78RansFrameStreamingDecoder final : public core::Transform {
public:
    Lz78RansFrameStreamingDecoder(
...
private:
    ...
    std::array<std::byte, lz78_rans_stream_prefix_size> prefix_bytes_{};
