#ifndef MARC_FRAME_LZ78_STREAMING_DECODER_HPP
#define MARC_FRAME_LZ78_STREAMING_DECODER_HPP
...
class Lz78FrameStreamingDecoder final : public core::Transform {
public:
    Lz78FrameStreamingDecoder(
...
private:
    ...
    std::span<dictionary::internal::Lz78PhraseEntry> dictionary_workspace_{};
    std::array<std::byte, lz78_stream_prefix_size> prefix_bytes_{};
