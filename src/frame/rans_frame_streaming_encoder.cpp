...
RansFrameStreamingEncoder::RansFrameStreamingEncoder(
...
core::ProcessResult RansFrameStreamingEncoder::fail(
...
bool RansFrameStreamingEncoder::prepare_frame() noexcept {
    ...
    if (encoded.error != RansFrameCodecError::none) return false;
...
core::ProcessResult RansFrameStreamingEncoder::process(
