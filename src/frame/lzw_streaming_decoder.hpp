#ifndef MARC_FRAME_LZW_STREAMING_DECODER_HPP
#define MARC_FRAME_LZW_STREAMING_DECODER_HPP
...
class LzwFrameStreamingDecoder final : public core::Transform {
public:
    LzwFrameStreamingDecoder(
...
private:
    ...
    std::span<dictionary::internal::LzwPhraseEntry> dictionary_workspace_{};
    std::array<std::byte, lzw_stream_prefix_size> prefix_bytes_{};
