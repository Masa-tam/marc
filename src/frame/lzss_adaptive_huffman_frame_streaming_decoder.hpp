#ifndef MARC_FRAME_LZSS_ADAPTIVE_HUFFMAN_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZSS_ADAPTIVE_HUFFMAN_FRAME_STREAMING_DECODER_HPP
...
class LzssAdaptiveHuffmanFrameStreamingDecoder final
...
private:
    ...
    std::array<std::byte, lzss_adaptive_huffman_stream_prefix_size>
        prefix_bytes_{};
