#ifndef MARC_FRAME_LZ77_RANS_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZ77_RANS_FRAME_STREAMING_DECODER_HPP
...
class Lz77RansFrameStreamingDecoder final : public core::Transform {
public:
    Lz77RansFrameStreamingDecoder(
...
private:
    ...
    std::array<std::byte, lz77_rans_stream_prefix_size> prefix_bytes_{};
