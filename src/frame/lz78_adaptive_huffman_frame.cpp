...
plan_lz78_adaptive_huffman_frame(
    ...
    if (input.empty()
        ...
        result.error =
            Lz78AdaptiveHuffmanFrameValidationError::input_size_mismatch;
        return result;
    }
    ...
    if (entropy_plan.error
        ...
        result.error =
            Lz78AdaptiveHuffmanFrameValidationError::entropy_encode_error;
        return result;
    }
...
encode_lz78_adaptive_huffman_frame(
    ...
    const std::span<std::byte> dictionary_staging,
    const std::span<std::byte> output) noexcept {
    auto result = plan_lz78_adaptive_huffman_frame(
    ...
    if (entropy_plan.error
        ...
        result.entropy_encode_error = entropy_plan.error;
        result.error = Lz78AdaptiveHuffmanFrameValidationError::internal_error;
        return result;
    }
