#ifndef MARC_FRAME_LZW_TANS_FRAME_STREAMING_ENCODER_HPP
#define MARC_FRAME_LZW_TANS_FRAME_STREAMING_ENCODER_HPP
...
inline constexpr std::size_t lzw_tans_stream_prefix_size =
    stream_header_size + dictionary::internal::lzw_parameter_size;

class LzwTansFrameStreamingEncoder final : public core::Transform {
public:
    LzwTansFrameStreamingEncoder(
        StreamHeader stream,
...
private:
    ...
    std::array<std::byte, lzw_tans_stream_prefix_size> prefix_{};
    std::size_t frame_input_size_{};
    std::size_t pending_size_{lzw_tans_stream_prefix_size};
