#ifndef MARC_FRAME_LZD_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZD_FRAME_STREAMING_DECODER_HPP
...
class LzdFrameStreamingDecoder final : public core::Transform {
public:
    LzdFrameStreamingDecoder(
...
private:
    ...
    std::array<std::byte, lzd_stream_prefix_size> prefix_bytes_{};
