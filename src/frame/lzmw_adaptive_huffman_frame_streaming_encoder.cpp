...
LzmwAdaptiveHuffmanFrameStreamingEncoder::
LzmwAdaptiveHuffmanFrameStreamingEncoder(
...
core::ProcessResult LzmwAdaptiveHuffmanFrameStreamingEncoder::fail(
...
bool LzmwAdaptiveHuffmanFrameStreamingEncoder::prepare_frame() noexcept {
    preparation_error_ = core::ErrorCode::internal_error;
    const auto plan = plan_lzmw_adaptive_huffman_frame(
        ...
        dictionary_staging_);
    if (plan.error != LzmwAdaptiveHuffmanFrameValidationError::none) {
        switch (plan.error) {
        case LzmwAdaptiveHuffmanFrameValidationError::input_size_mismatch:
        case LzmwAdaptiveHuffmanFrameValidationError::unsupported_pipeline:
            preparation_error_ = core::ErrorCode::invalid_argument;
            break;
        case LzmwAdaptiveHuffmanFrameValidationError::
        ...
        case LzmwAdaptiveHuffmanFrameValidationError::
            ...
            break;
        case LzmwAdaptiveHuffmanFrameValidationError::workspace_limit:
        case LzmwAdaptiveHuffmanFrameValidationError::
            invalid_dictionary_extent:
        case LzmwAdaptiveHuffmanFrameValidationError::invalid_entropy_extent:
        case LzmwAdaptiveHuffmanFrameValidationError::dictionary_encode_error:
        case LzmwAdaptiveHuffmanFrameValidationError::entropy_encode_error:
        case LzmwAdaptiveHuffmanFrameValidationError::header_error:
        case LzmwAdaptiveHuffmanFrameValidationError::arithmetic_overflow:
    ...
    const auto encoded = encode_lzmw_adaptive_huffman_frame(
        stream_, parameters_, limits_, frame_sequence_, input_committed_,
        frame_input_storage_.first(frame_input_size_), encoder_workspace_,
        dictionary_staging_,
        frame_encoded_storage_.first(plan.serialized_size));
    if (encoded.error != LzmwAdaptiveHuffmanFrameValidationError::none) {
        return false;
    }
...
core::ProcessResult LzmwAdaptiveHuffmanFrameStreamingEncoder::process(
