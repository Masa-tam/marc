...
LzwFrameStreamingEncoder::LzwFrameStreamingEncoder(
...
core::ProcessResult LzwFrameStreamingEncoder::fail(
...
bool LzwFrameStreamingEncoder::prepare_frame() noexcept {
    ...
    if (plan.error != LzwFrameCodecError::none) {
        if (plan.error == LzwFrameCodecError::input_size_mismatch)
            preparation_error_ = core::ErrorCode::invalid_argument;
        else if (plan.encode_error
                     == dictionary::internal::LzwEncodeError::input_limit_exceeded
                 || plan.encode_error
                     == dictionary::internal::LzwEncodeError::serialized_limit_exceeded
                 || plan.encode_error
                     == dictionary::internal::LzwEncodeError::workspace_limit_exceeded)
            preparation_error_ = core::ErrorCode::limit_exceeded;
        else if (plan.encode_error
                 == dictionary::internal::LzwEncodeError::workspace_too_small)
    ...
    if (encoded.error != LzwFrameCodecError::none) return false;
...
core::ProcessResult LzwFrameStreamingEncoder::process(
