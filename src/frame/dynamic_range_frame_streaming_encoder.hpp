#ifndef MARC_FRAME_DYNAMIC_RANGE_FRAME_STREAMING_ENCODER_HPP
#define MARC_FRAME_DYNAMIC_RANGE_FRAME_STREAMING_ENCODER_HPP
...
class DynamicRangeFrameStreamingEncoder final : public core::Transform {
public:
    DynamicRangeFrameStreamingEncoder(
