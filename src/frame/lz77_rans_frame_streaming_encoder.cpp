...
Lz77RansFrameStreamingEncoder::Lz77RansFrameStreamingEncoder(
...
core::ProcessResult Lz77RansFrameStreamingEncoder::fail(
...
bool Lz77RansFrameStreamingEncoder::prepare_frame() noexcept {
    preparation_error_ = core::ErrorCode::internal_error;
    const auto plan = plan_lz77_rans_frame(
    ...
    if (plan.error != Lz77RansFrameValidationError::none) {
        switch (plan.error) {
        case Lz77RansFrameValidationError::input_size_mismatch:
        case Lz77RansFrameValidationError::unsupported_pipeline:
            preparation_error_ = core::ErrorCode::invalid_argument;
            break;
        case Lz77RansFrameValidationError::dictionary_staging_too_small:
        case Lz77RansFrameValidationError::serialized_output_too_small:
            preparation_error_ = core::ErrorCode::out_of_memory;
            break;
        case Lz77RansFrameValidationError::workspace_limit:
        case Lz77RansFrameValidationError::invalid_dictionary_extent:
        case Lz77RansFrameValidationError::invalid_entropy_extent:
        case Lz77RansFrameValidationError::dictionary_encode_error:
        case Lz77RansFrameValidationError::entropy_encode_error:
        case Lz77RansFrameValidationError::header_error:
        case Lz77RansFrameValidationError::arithmetic_overflow:
    ...
    const auto encoded = encode_lz77_rans_frame(
        stream_, parameters_, limits_, frame_sequence_, input_committed_,
        frame_input_storage_.first(frame_input_size_), dictionary_staging_,
        frame_encoded_storage_.first(plan.serialized_size));
    if (encoded.error != Lz77RansFrameValidationError::none) {
        return false;
    }
...
core::ProcessResult Lz77RansFrameStreamingEncoder::process(
