...
Lz77BlockedHuffmanFrameStreamingDecoder::
Lz77BlockedHuffmanFrameStreamingDecoder(
...
core::ProcessResult Lz77BlockedHuffmanFrameStreamingDecoder::fail(
...
bool Lz77BlockedHuffmanFrameStreamingDecoder::parse_collected_prefix()
    noexcept {
...
bool Lz77BlockedHuffmanFrameStreamingDecoder::parse_collected_frame_header()
    noexcept {
...
bool Lz77BlockedHuffmanFrameStreamingDecoder::decode_collected_frame()
    noexcept {
    const auto decoded = decode_lz77_blocked_huffman_frame(
...
core::ProcessResult Lz77BlockedHuffmanFrameStreamingDecoder::process(
    ...
    while (true) {
        ...
        if (state_ == State::collecting_prefix) {
            const auto needed = lz77_blocked_huffman_stream_prefix_size
                - header_collected_;
