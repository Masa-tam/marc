#ifndef MARC_FRAME_LZ78_DYNAMIC_RANGE_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZ78_DYNAMIC_RANGE_FRAME_STREAMING_DECODER_HPP
...
class Lz78DynamicRangeFrameStreamingDecoder final : public core::Transform {
public:
...
private:
    ...
    std::array<std::byte, lz78_dynamic_range_stream_prefix_size>
        prefix_bytes_{};
