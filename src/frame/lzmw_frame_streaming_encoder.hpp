#ifndef MARC_FRAME_LZMW_FRAME_STREAMING_ENCODER_HPP
#define MARC_FRAME_LZMW_FRAME_STREAMING_ENCODER_HPP
...
class LzmwFrameStreamingEncoder final : public core::Transform {
public:
    LzmwFrameStreamingEncoder(
        StreamHeader stream, dictionary::internal::LzmwParameters parameters,
...
private:
    ...
    std::span<dictionary::internal::LzmwEncoderEntry> dictionary_workspace_{};
    std::array<std::byte, lzmw_stream_prefix_size> prefix_{};
    std::size_t frame_input_size_{};
    std::size_t pending_size_{lzmw_stream_prefix_size};
