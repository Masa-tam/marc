...
Lz78AdaptiveHuffmanFrameStreamingEncoder::
Lz78AdaptiveHuffmanFrameStreamingEncoder(
...
core::ProcessResult Lz78AdaptiveHuffmanFrameStreamingEncoder::fail(
...
bool Lz78AdaptiveHuffmanFrameStreamingEncoder::prepare_frame() noexcept {
    ...
    const auto plan = plan_lz78_adaptive_huffman_frame(
        ...
        dictionary_staging_);
    if (plan.error != Lz78AdaptiveHuffmanFrameValidationError::none) {
        switch (plan.error) {
        case Lz78AdaptiveHuffmanFrameValidationError::input_size_mismatch:
        case Lz78AdaptiveHuffmanFrameValidationError::unsupported_pipeline:
            preparation_error_ = core::ErrorCode::invalid_argument;
            break;
        case Lz78AdaptiveHuffmanFrameValidationError::
        ...
        case Lz78AdaptiveHuffmanFrameValidationError::
            ...
            break;
        case Lz78AdaptiveHuffmanFrameValidationError::workspace_limit:
        case Lz78AdaptiveHuffmanFrameValidationError::
            invalid_dictionary_extent:
        case Lz78AdaptiveHuffmanFrameValidationError::invalid_entropy_extent:
        case Lz78AdaptiveHuffmanFrameValidationError::dictionary_encode_error:
        case Lz78AdaptiveHuffmanFrameValidationError::entropy_encode_error:
        case Lz78AdaptiveHuffmanFrameValidationError::header_error:
        case Lz78AdaptiveHuffmanFrameValidationError::arithmetic_overflow:
    ...
    const auto encoded = encode_lz78_adaptive_huffman_frame(
        stream_, parameters_, limits_, frame_sequence_, input_committed_,
        frame_input_storage_.first(frame_input_size_), encoder_workspace_,
        dictionary_staging_,
        frame_encoded_storage_.first(plan.serialized_size));
    if (encoded.error != Lz78AdaptiveHuffmanFrameValidationError::none) {
        return false;
    }
...
core::ProcessResult Lz78AdaptiveHuffmanFrameStreamingEncoder::process(
