...
BlockedHuffmanFrameStreamingDecoder::BlockedHuffmanFrameStreamingDecoder(
...
core::ProcessResult BlockedHuffmanFrameStreamingDecoder::fail(
...
bool BlockedHuffmanFrameStreamingDecoder::parse_collected_stream_header()
    noexcept {
...
bool BlockedHuffmanFrameStreamingDecoder::parse_collected_frame_header()
    noexcept {
...
bool BlockedHuffmanFrameStreamingDecoder::decode_collected_frame() noexcept {
    const auto decoded = decode_blocked_huffman_frame(
        stream_, limits_, frame_sequence_, output_committed_,
...
core::ProcessResult BlockedHuffmanFrameStreamingDecoder::process(
