#ifndef MARC_FRAME_LZD_BLOCKED_HUFFMAN_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZD_BLOCKED_HUFFMAN_FRAME_STREAMING_DECODER_HPP
...
class LzdBlockedHuffmanFrameStreamingDecoder final : public core::Transform {
public:
...
private:
    ...
    std::array<std::byte, lzd_blocked_huffman_stream_prefix_size>
        prefix_bytes_{};
