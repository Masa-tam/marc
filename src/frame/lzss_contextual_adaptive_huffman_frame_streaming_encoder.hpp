#ifndef MARC_FRAME_LZSS_CONTEXTUAL_ADAPTIVE_HUFFMAN_FRAME_STREAMING_ENCODER_HPP
#define MARC_FRAME_LZSS_CONTEXTUAL_ADAPTIVE_HUFFMAN_FRAME_STREAMING_ENCODER_HPP
...
class LzssContextualAdaptiveHuffmanFrameStreamingEncoder final
