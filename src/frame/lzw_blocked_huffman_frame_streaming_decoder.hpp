#ifndef MARC_FRAME_LZW_BLOCKED_HUFFMAN_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZW_BLOCKED_HUFFMAN_FRAME_STREAMING_DECODER_HPP
...
class LzwBlockedHuffmanFrameStreamingDecoder final : public core::Transform {
public:
  LzwBlockedHuffmanFrameStreamingDecoder(
      core::DecoderLimits limits, std::span<std::byte> frame_encoded_storage,
...
private:
  ...
  std::span<dictionary::internal::LzwPhraseEntry> phrase_workspace_{};
  std::array<std::byte, lzw_blocked_huffman_stream_prefix_size> prefix_bytes_{};
