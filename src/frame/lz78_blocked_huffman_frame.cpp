...
Lz78BlockedHuffmanFrameValidationResult plan_lz78_blocked_huffman_frame(
  ...
  if (input.empty() ||
    ...
    result.error = Lz78BlockedHuffmanFrameValidationError::input_size_mismatch;
    return result;
  }

  result.encoder_entries = dictionary::internal::lz78_encoder_workspace_entries(
  ...
  const auto dictionary_plan = dictionary::internal::plan_lz78_token_stream(
  ...
  if (dictionary_plan.error != dictionary::internal::Lz78EncodeError::none) {
    result.error =
        Lz78BlockedHuffmanFrameValidationError::dictionary_encode_error;
    return result;
  }
  ...
  if (dictionary_encoded.error != dictionary::internal::Lz78EncodeError::none) {
    result.error =
        Lz78BlockedHuffmanFrameValidationError::dictionary_encode_error;
    return result;
  }
  ...
  if (entropy_plan.error !=
    ...
    result.error = Lz78BlockedHuffmanFrameValidationError::entropy_encode_error;
    return result;
  }
...
Lz78BlockedHuffmanFrameValidationResult encode_lz78_blocked_huffman_frame(
    const StreamHeader &stream,
    const dictionary::internal::Lz78Parameters &parameters,
    const core::DecoderLimits &limits, const std::uint64_t sequence,
    const std::uint64_t output_already_committed,
  ...
  auto result = plan_lz78_blocked_huffman_frame(
  ...
  if (serialize_frame_header(header, context, header_output) !=
    ...
    result.error = Lz78BlockedHuffmanFrameValidationError::internal_error;
    return result;
  }
