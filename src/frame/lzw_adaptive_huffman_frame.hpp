...
// in private dictionary staging before planning Adaptive Huffman over those
// exact bytes. Raw input and staging must not overlap.
...
// Plans completely before writing serialized output. Input, packed staging,
