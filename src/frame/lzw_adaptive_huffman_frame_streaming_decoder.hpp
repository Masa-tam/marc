#ifndef MARC_FRAME_LZW_ADAPTIVE_HUFFMAN_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZW_ADAPTIVE_HUFFMAN_FRAME_STREAMING_DECODER_HPP
...
class LzwAdaptiveHuffmanFrameStreamingDecoder final
...
private:
    ...
    std::array<std::byte, lzw_adaptive_huffman_stream_prefix_size>
        prefix_bytes_{};
