#ifndef MARC_FRAME_LZSS_DYNAMIC_RANGE_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZSS_DYNAMIC_RANGE_FRAME_STREAMING_DECODER_HPP
...
class LzssDynamicRangeFrameStreamingDecoder final : public core::Transform {
public:
    LzssDynamicRangeFrameStreamingDecoder(
...
private:
    ...
    std::array<std::byte, lzss_dynamic_range_stream_prefix_size>
        prefix_bytes_{};
