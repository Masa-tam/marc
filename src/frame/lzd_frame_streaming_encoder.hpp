#ifndef MARC_FRAME_LZD_FRAME_STREAMING_ENCODER_HPP
#define MARC_FRAME_LZD_FRAME_STREAMING_ENCODER_HPP
...
class LzdFrameStreamingEncoder final : public core::Transform {
public:
    LzdFrameStreamingEncoder(
...
private:
    ...
    std::span<dictionary::internal::LzdEncoderEntry> dictionary_workspace_{};
    std::array<std::byte, lzd_stream_prefix_size> prefix_{};
    std::size_t frame_input_size_{};
    std::size_t pending_size_{lzd_stream_prefix_size};
