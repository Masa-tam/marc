#ifndef MARC_FRAME_RANS_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_RANS_FRAME_STREAMING_DECODER_HPP
...
class RansFrameStreamingDecoder final : public core::Transform {
public:
    RansFrameStreamingDecoder(
