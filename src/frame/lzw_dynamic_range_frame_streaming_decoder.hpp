#ifndef MARC_FRAME_LZW_DYNAMIC_RANGE_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZW_DYNAMIC_RANGE_FRAME_STREAMING_DECODER_HPP
...
class LzwDynamicRangeFrameStreamingDecoder final : public core::Transform {
public:
...
private:
    ...
    std::array<std::byte, lzw_dynamic_range_stream_prefix_size> prefix_bytes_{};
