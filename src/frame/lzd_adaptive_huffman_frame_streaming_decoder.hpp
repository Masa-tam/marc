#ifndef MARC_FRAME_LZD_ADAPTIVE_HUFFMAN_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZD_ADAPTIVE_HUFFMAN_FRAME_STREAMING_DECODER_HPP
...
class LzdAdaptiveHuffmanFrameStreamingDecoder final
...
private:
    ...
    std::array<std::byte, lzd_adaptive_huffman_stream_prefix_size>
        prefix_bytes_{};
