#ifndef MARC_FRAME_LZ77_DYNAMIC_RANGE_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZ77_DYNAMIC_RANGE_FRAME_STREAMING_DECODER_HPP
...
class Lz77DynamicRangeFrameStreamingDecoder final : public core::Transform {
public:
...
private:
    ...
    std::array<std::byte, lz77_dynamic_range_stream_prefix_size>
        prefix_bytes_{};
