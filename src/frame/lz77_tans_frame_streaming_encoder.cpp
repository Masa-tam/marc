...
Lz77TansFrameStreamingEncoder::Lz77TansFrameStreamingEncoder(
...
core::ProcessResult Lz77TansFrameStreamingEncoder::fail(
...
bool Lz77TansFrameStreamingEncoder::prepare_frame() noexcept {
    ...
    if (plan.error != Lz77TansFrameValidationError::none) {
        switch (plan.error) {
        case Lz77TansFrameValidationError::input_size_mismatch:
        case Lz77TansFrameValidationError::unsupported_pipeline:
            preparation_error_ = core::ErrorCode::invalid_argument;
            break;
        case Lz77TansFrameValidationError::dictionary_staging_too_small:
        case Lz77TansFrameValidationError::serialized_output_too_small:
            preparation_error_ = core::ErrorCode::out_of_memory;
            break;
        case Lz77TansFrameValidationError::workspace_limit:
        case Lz77TansFrameValidationError::invalid_dictionary_extent:
        case Lz77TansFrameValidationError::invalid_entropy_extent:
        case Lz77TansFrameValidationError::dictionary_encode_error:
        case Lz77TansFrameValidationError::entropy_encode_error:
        case Lz77TansFrameValidationError::header_error:
        case Lz77TansFrameValidationError::arithmetic_overflow:
    ...
    const auto encoded = encode_lz77_tans_frame(
        stream_, parameters_, limits_, frame_sequence_, input_committed_,
        frame_input_storage_.first(frame_input_size_), dictionary_staging_,
        frame_encoded_storage_.first(plan.serialized_size));
    if (encoded.error != Lz77TansFrameValidationError::none) {
        return false;
    }
...
core::ProcessResult Lz77TansFrameStreamingEncoder::process(
