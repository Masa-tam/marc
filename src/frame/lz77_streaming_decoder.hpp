#ifndef MARC_FRAME_LZ77_STREAMING_DECODER_HPP
#define MARC_FRAME_LZ77_STREAMING_DECODER_HPP
...
class Lz77FrameStreamingDecoder final : public core::Transform {
public:
    Lz77FrameStreamingDecoder(
...
private:
    ...
    std::array<std::byte, lz77_stream_prefix_size> prefix_bytes_{};
