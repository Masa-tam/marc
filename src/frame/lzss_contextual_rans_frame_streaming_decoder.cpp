...
parse_collected_stream_header() noexcept {
    ...
    case LzssContextualRansStreamAdmission::field_context_4m:
        return stream_.dictionary_variant == 4
            && stream_.context_variant == 3;
    case LzssContextualRansStreamAdmission::field_context_16m:
        return stream_.dictionary_variant == 5
            && stream_.context_variant == 4;
    case LzssContextualRansStreamAdmission::field_context_64m:
...
bool LzssContextualRansFrameStreamingDecoder::prepare_collected_frame()
    ...
    if (!core::checked_add(
            ...
            static_cast<std::size_t>(frame_.descriptor_size),
            serialized_size)
        || !core::checked_add(
