...
LzssAdaptiveHuffmanFrameStreamingDecoder::
LzssAdaptiveHuffmanFrameStreamingDecoder(
...
core::ProcessResult LzssAdaptiveHuffmanFrameStreamingDecoder::fail(
...
bool LzssAdaptiveHuffmanFrameStreamingDecoder::parse_collected_prefix()
    noexcept {
...
bool LzssAdaptiveHuffmanFrameStreamingDecoder::
...
bool LzssAdaptiveHuffmanFrameStreamingDecoder::decode_collected_frame()
    noexcept {
    const auto decoded = decode_lzss_adaptive_huffman_frame_to_staging(
...
core::ProcessResult LzssAdaptiveHuffmanFrameStreamingDecoder::process(
    ...
    while (true) {
        ...
        if (state_ == State::collecting_prefix) {
            const auto needed = lzss_adaptive_huffman_stream_prefix_size
                - header_collected_;
