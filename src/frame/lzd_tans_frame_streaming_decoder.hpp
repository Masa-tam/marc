#ifndef MARC_FRAME_LZD_TANS_FRAME_STREAMING_DECODER_HPP
#define MARC_FRAME_LZD_TANS_FRAME_STREAMING_DECODER_HPP
...
class LzdTansFrameStreamingDecoder final : public core::Transform {
public:
    LzdTansFrameStreamingDecoder(
...
private:
    ...
    std::array<std::byte, lzd_tans_stream_prefix_size> prefix_bytes_{};
