...
constexpr std::size_t maximum_phrases =
    maximum_dictionary / marc::dictionary::internal::lzmw_token_size - 1;
...
void exercise_streaming(const std::span<const std::byte> input) noexcept {
    ...
    marc::frame::LzmwBlockedHuffmanFrameStreamingDecoder decoder{
