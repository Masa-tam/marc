...
constexpr std::size_t maximum_phrase_entries =
    maximum_payload / marc::dictionary::internal::lzmw_token_size;
...
extern "C" int LLVMFuzzerTestOneInput(const std::uint8_t* data,
    ...
    static_cast<void>(marc::frame::decode_lzmw_stream(
