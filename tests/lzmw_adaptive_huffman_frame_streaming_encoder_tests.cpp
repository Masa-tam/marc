...
[[nodiscard]] std::vector<std::byte> reference() {
    ...
    std::vector<std::byte> output(lzmw_adaptive_huffman_stream_prefix_size);
    ...
    while (committed < input.size()) {
        ...
        EXPECT_EQ(encode_lzmw_adaptive_huffman_frame(
...
TEST(LzmwAdaptiveHuffmanFrameStreamingEncoder,
    ...
    std::array<marc::dictionary::internal::LzmwEncoderEntry, 1> entries{};
    LzmwAdaptiveHuffmanFrameStreamingEncoder encoder{
...
TEST(LzmwAdaptiveHuffmanFrameStreamingEncoder,
    ...
    EXPECT_EQ(first.output_produced,
              lzmw_adaptive_huffman_stream_prefix_size);
...
TEST(LzmwAdaptiveHuffmanFrameStreamingEncoder,
    ...
    LzmwAdaptiveHuffmanFrameStreamingEncoder short_input{
        config(input.size()), {}, {},
    ...
    LzmwAdaptiveHuffmanFrameStreamingEncoder short_dictionary{
    ...
    EXPECT_EQ(short_dictionary.process({}, {}, 0).error.code,
              marc::core::ErrorCode::out_of_memory);
    LzmwAdaptiveHuffmanFrameStreamingEncoder short_entries{
        config(input.size()), {}, {}, frame_input, staging, frame_encoded, {}};
    EXPECT_EQ(short_entries.process({}, {}, 0).error.code,
              marc::core::ErrorCode::out_of_memory);

    LzmwAdaptiveHuffmanFrameStreamingEncoder short_encoded{
    ...
    limits.max_internal_buffered_bytes = 2 + plan.dictionary_size
        ...
        - 1;
    LzmwAdaptiveHuffmanFrameStreamingEncoder aggregate_limited{
...
TEST(LzmwAdaptiveHuffmanFrameStreamingEncoder,
    ...
    std::array<std::byte, lzmw_adaptive_huffman_stream_prefix_size> output{};
    LzmwAdaptiveHuffmanFrameStreamingEncoder empty{
        config(0), {}, {}, {}, {}, unused, {}};
    ...
    std::array<std::byte, 2048> frame_encoded{};
    std::array<marc::dictionary::internal::LzmwEncoderEntry, 1> entries{};
    LzmwAdaptiveHuffmanFrameStreamingEncoder premature{
        config(input.size()), {}, {}, frame_input, staging, frame_encoded,
        entries};
    ...
    LzmwAdaptiveHuffmanFrameStreamingEncoder excess{
        config(1), {}, {}, frame_input, staging, frame_encoded, entries};
    result = excess.process(input, {}, 0);
    EXPECT_EQ(result.error.code, marc::core::ErrorCode::invalid_argument);

    LzmwAdaptiveHuffmanFrameStreamingEncoder reset{
        config(input.size()), {}, {}, frame_input, staging, frame_encoded,
        entries};
    ...
    LzmwAdaptiveHuffmanFrameStreamingEncoder unknown{
        config(input.size()), {}, {}, frame_input, staging, frame_encoded,
        entries};
