...
class LzssContextualTansFuzzRegression : public testing::Test {
protected:
...
TEST_F(LzssContextualTansFuzzRegression, EveryCanonicalTruncationIsAtomic) {
...
TEST_F(LzssContextualTansFuzzRegression, ExtremeFrameLengthsAreAtomic) {
...
TEST_F(LzssContextualTansFuzzRegression,
