...
int main(void) {
    ...
    assert(marc_lzss_contextual_rans_compact_config_init(
    ...
    assert(marc_lzss_contextual_rans_compact_workspace_requirements(
    ...
    assert(marc_lzss_contextual_rans_compact_create(
