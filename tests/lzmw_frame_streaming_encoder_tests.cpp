...
TEST(LzmwFrameStreamingEncoder, MatchesReferenceWithOneByteBuffers) {
    const auto expected = reference();
    std::array<std::byte, 2> frame_input{};
    std::array<std::byte, 64> frame_encoded{};
    std::array<marc::dictionary::internal::LzmwEncoderEntry, 1> dictionary{};
    LzmwFrameStreamingEncoder encoder{
...
TEST(LzmwFrameStreamingEncoder, EmitsFramesAndKeepsFlushOpen) {
    const auto expected = reference();
    std::array<std::byte, 2> frame_input{};
    std::array<std::byte, 64> frame_encoded{};
    std::array<marc::dictionary::internal::LzmwEncoderEntry, 1> dictionary{};
    ...
    EXPECT_EQ(first.output_produced, lzmw_stream_prefix_size);
...
TEST(LzmwFrameStreamingEncoder, EncodesFinalShortBinaryFrame) {
...
TEST(LzmwFrameStreamingEncoder, ReportsWorkspaceAndAggregateLimits) {
    std::array<std::byte, 2> frame_input{};
    std::array<std::byte, 64> frame_encoded{};
    std::array<marc::dictionary::internal::LzmwEncoderEntry, 1> dictionary{};
    std::array<std::byte, 1> short_input{};
    LzmwFrameStreamingEncoder no_input{
    ...
    LzmwFrameStreamingEncoder no_encoded{
    ...
    LzmwFrameStreamingEncoder no_dictionary{
    ...
    LzmwFrameStreamingEncoder limited{
...
TEST(LzmwFrameStreamingEncoder, RejectsPrematureEndAndTrailingInput) {
    std::array<std::byte, 2> frame_input{};
    std::array<std::byte, 64> frame_encoded{};
    std::array<marc::dictionary::internal::LzmwEncoderEntry, 1> dictionary{};
    LzmwFrameStreamingEncoder premature{
        config(input.size()), {}, {}, frame_input, frame_encoded, dictionary};
    ...
    LzmwFrameStreamingEncoder trailing{
...
TEST(LzmwFrameStreamingEncoder, HandlesEmptyLateEndAndTerminalErrors) {
    std::array<std::byte, 1> unused{};
    std::array<std::byte, lzmw_stream_prefix_size> output{};
    LzmwFrameStreamingEncoder empty{
        config(0), {}, {}, {}, unused, {}};
    auto result = empty.process(
        {}, output,
        marc::core::flag_value(marc::core::ProcessFlags::end_input));
    EXPECT_EQ(result.status, marc::core::StreamStatus::end_of_stream);
    EXPECT_EQ(result.output_produced, lzmw_stream_prefix_size);

    std::array<std::byte, 2> frame_input{};
    std::array<std::byte, 64> frame_encoded{};
    std::array<marc::dictionary::internal::LzmwEncoderEntry, 1> dictionary{};
    LzmwFrameStreamingEncoder late_end{
        config(2), {}, {}, frame_input, frame_encoded, dictionary};
    std::array<std::byte, lzmw_stream_prefix_size + 64> encoded{};
    ...
    LzmwFrameStreamingEncoder reset{
        config(2), {}, {}, frame_input, frame_encoded, dictionary};
    ...
    LzmwFrameStreamingEncoder unknown{
        config(2), {}, {}, frame_input, frame_encoded, dictionary};
    ...
    LzmwFrameStreamingEncoder invalid{
