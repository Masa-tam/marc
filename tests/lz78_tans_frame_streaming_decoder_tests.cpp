...
TEST(Lz78TansFrameStreamingDecoder, DecodesOneByteInputAndOutput) {
...
TEST(Lz78TansFrameStreamingDecoder,
     CommitsOnlyFramesBeforeLaterCorruption) {
    auto encoded = encoded_stream();
    const auto first_size =
        frame_size_at(encoded, lz78_tans_stream_prefix_size);
    const auto second_offset = lz78_tans_stream_prefix_size + first_size;
...
TEST(Lz78TansFrameStreamingDecoder, ReportsWorkspaceAndAggregateErrors) {
    const auto encoded = encoded_stream();
    const auto first_size =
        frame_size_at(encoded, lz78_tans_stream_prefix_size);
    Workspace workspace{};
    ...
    Lz78TansFrameStreamingDecoder short_encoded{
        {},
    ...
    Lz78TansFrameStreamingDecoder short_views{
    ...
    Lz78TansFrameStreamingDecoder short_dictionary{
        {}, workspace.frame_encoded, workspace.views,
    ...
    Lz78TansFrameStreamingDecoder short_decoded{
        {}, workspace.frame_encoded, workspace.views,
    ...
    Lz78TansFrameStreamingDecoder short_phrases{
        {}, workspace.frame_encoded, workspace.views,
        workspace.dictionary_staging, workspace.frame_decoded,
    ...
    Lz78TansFrameStreamingDecoder aggregate_limited{
...
TEST(Lz78TansFrameStreamingDecoder, RejectsTruncationTrailingAndReset) {
    const auto encoded = encoded_stream();
    Workspace workspace{};
    std::array<std::byte, raw.size()> output{};
    const auto end =
    ...
    Lz78TansFrameStreamingDecoder truncated{
        {}, workspace.frame_encoded, workspace.views,
        workspace.dictionary_staging, workspace.frame_decoded,
        workspace.phrases};
    EXPECT_EQ(
    ...
    Lz78TansFrameStreamingDecoder trailing{
        {}, workspace.frame_encoded, workspace.views,
        workspace.dictionary_staging, workspace.frame_decoded,
        workspace.phrases};
    ...
    Lz78TansFrameStreamingDecoder reset{
        {}, workspace.frame_encoded, workspace.views,
        workspace.dictionary_staging, workspace.frame_decoded,
        workspace.phrases};
    ...
    Lz78TansFrameStreamingDecoder unknown{
        {}, workspace.frame_encoded, workspace.views,
        workspace.dictionary_staging, workspace.frame_decoded,
        workspace.phrases};
...
TEST(Lz78TansFrameStreamingDecoder, HandlesEmptyFlushAndPrematureEnd) {
    const auto empty_encoded = encoded_stream({});
    Lz78TansFrameStreamingDecoder empty{{}, {}, {}, {}, {}, {}};
    ...
    Workspace workspace{};
    Lz78TansFrameStreamingDecoder starved{
        {}, workspace.frame_encoded, workspace.views,
        workspace.dictionary_staging, workspace.frame_decoded,
        workspace.phrases};
    ...
    const auto prefix_and_first_frame =
        lz78_tans_stream_prefix_size + first_size;
    Lz78TansFrameStreamingDecoder premature{
        {}, workspace.frame_encoded, workspace.views,
        workspace.dictionary_staging, workspace.frame_decoded,
        workspace.phrases};
    std::array<std::byte, 1> output{};
