...
TEST(Lz78RansProfile, BuildsCanonicalDefaultAndWorstCaseWorkspace) {
    StreamHeader stream{};
    Lz78RansEncoderWorkspaceRequirements workspace{};
    ASSERT_EQ(make_lz78_rans_profile(
                  {2'500'000}, {}, stream, workspace),
              Lz78RansProfileError::none);
    ...
    EXPECT_EQ(workspace.frame_encoded_bytes, 528'632U);
...
TEST(Lz78RansProfile, HonorsShortFrameFreezeAndEmptyStream) {
    StreamHeader stream{};
    Lz78RansEncoderWorkspaceRequirements workspace{};
    Lz78RansProfileConfig short_config{17};
    ...
    EXPECT_EQ(workspace.frame_encoded_bytes, 728U);
    EXPECT_EQ(workspace.encoder_entry_count, 2U);

    workspace = {1, 1, 1, 1, 1, 8};
    ASSERT_EQ(make_lz78_rans_profile({}, {}, stream, workspace),
              Lz78RansProfileError::none);
...
TEST(Lz78RansProfile, EnforcesBlockPayloadAggregateAndFrameLimits) {
    StreamHeader stream{};
    Lz78RansEncoderWorkspaceRequirements workspace{};
    auto limits = marc::core::DecoderLimits{};
    limits.max_blocks_per_frame = 1;
    EXPECT_EQ(make_lz78_rans_profile(
                  {2, 2, 8, {}}, limits, stream, workspace),
              Lz78RansProfileError::limit_exceeded);

    limits = {};
    limits.max_compressed_payload_size = 143;
    EXPECT_EQ(make_lz78_rans_profile(
    ...
    Lz78RansProfileConfig invalid{};
    invalid.parameters.maximum_entries = 0;
    EXPECT_EQ(make_lz78_rans_profile(
                  invalid, {}, stream, workspace),
              Lz78RansProfileError::invalid_configuration);
}

TEST(Lz78RansProfile, CalculatesDecoderLayoutFromLocalLimits) {
    auto limits = marc::core::DecoderLimits{};
    ...
    Lz78RansDecoderWorkspaceRequirements workspace{};
    ASSERT_EQ(calculate_lz78_rans_decoder_workspace(limits, workspace),
              Lz78RansProfileError::none);
    ...
    EXPECT_EQ(calculate_lz78_rans_decoder_workspace(limits, workspace),
              Lz78RansProfileError::arithmetic_overflow);
    EXPECT_EQ(workspace.frame_encoded_bytes, 0U);
}

TEST(Lz78RansProfile, PartitionsEncoderAndDecoderOpaqueStorage) {
    StreamHeader stream{};
    Lz78RansEncoderWorkspaceRequirements encoder{};
    ASSERT_EQ(make_lz78_rans_profile(
    ...
    if (encoder.views_alignment > 1) {
        ...
        EXPECT_EQ(partition_lz78_rans_encoder_views(
                  ...
                  Lz78RansWorkspaceError::misaligned);
    }
    ...
    limits.max_blocks_per_frame = 4;
    limits.max_dictionary_entries = 10;
    Lz78RansDecoderWorkspaceRequirements decoder{};
    ASSERT_EQ(calculate_lz78_rans_decoder_workspace(limits, decoder),
              Lz78RansProfileError::none);
    ...
    Lz78RansDecoderViews decoder_views{};
    ASSERT_EQ(partition_lz78_rans_decoder_views(
    ...
    EXPECT_EQ(partition_lz78_rans_decoder_views(
...
TEST(Lz78RansProfile, MapsStableCoreErrors) {
    EXPECT_EQ(lz78_rans_profile_error_code(Lz78RansProfileError::none),
              marc::core::ErrorCode::none);
    EXPECT_EQ(lz78_rans_profile_error_code(
                  Lz78RansProfileError::invalid_configuration),
              marc::core::ErrorCode::invalid_argument);
    EXPECT_EQ(lz78_rans_profile_error_code(
                  Lz78RansProfileError::unsupported),
...
TEST(Lz78RansProfile, RequirementsConstructStreamingRoundTrip) {
    ...
    const Lz78RansProfileConfig config{raw.size(), 2, 5, {}};
    StreamHeader stream{};
    Lz78RansEncoderWorkspaceRequirements encoder_ws{};
    ASSERT_EQ(make_lz78_rans_profile(
    ...
    Lz78RansEncoderViews encode_views{};
    ASSERT_EQ(partition_lz78_rans_encoder_views(
    ...
    Lz78RansDecoderWorkspaceRequirements decoder_ws{};
    ASSERT_EQ(calculate_lz78_rans_decoder_workspace(limits, decoder_ws),
              Lz78RansProfileError::none);
    ...
    Lz78RansDecoderViews decode_views{};
    ASSERT_EQ(partition_lz78_rans_decoder_views(
                  decoder_ws, decode_views_storage, decode_views),
              Lz78RansWorkspaceError::none);
    Lz78RansFrameStreamingDecoder decoder{
