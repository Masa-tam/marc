...
TEST(LzssContextualRansCompactFrameStreamingDecoder,
...
TEST(LzssContextualRansCompactFrameStreamingDecoder,
    ...
    LzssContextualRansCompactFrameStreamingDecoder short_frame{
    ...
    LzssContextualRansCompactFrameStreamingDecoder short_tables{
        {}, frame,
    ...
    LzssContextualRansCompactFrameStreamingDecoder short_tokens{
        {}, frame, table_storage, {}, raw};
    EXPECT_EQ(short_tokens.process(encoded, output, end_flag()).error.code,
              ErrorCode::out_of_memory);

    LzssContextualRansCompactFrameStreamingDecoder short_raw{
    ...
    LzssContextualRansCompactFrameStreamingDecoder aggregate_limited{
...
TEST(LzssContextualRansCompactFrameStreamingDecoder,
    ...
    LzssContextualRansCompactFrameStreamingDecoder truncated{
        {}, frame, table_storage, tokens, raw};
    ...
    LzssContextualRansCompactFrameStreamingDecoder trailing_decoder{
        {}, frame, table_storage, tokens, raw};
    EXPECT_EQ(trailing_decoder.process(
                  trailing, output, end_flag()).error.code,
              ErrorCode::malformed_stream);

    LzssContextualRansCompactFrameStreamingDecoder flags{
        {}, frame, table_storage, tokens, raw};
...
TEST(LzssContextualRansCompactFrameStreamingDecoder,
    ...
    LzssContextualRansCompactFrameStreamingDecoder empty_decoder{
        {}, {}, {}, {}, {}};
