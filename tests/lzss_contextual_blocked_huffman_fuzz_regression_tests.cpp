...
using Table = marc::entropy::internal::HuffmanDecodeTable;
...
[[nodiscard]] Workspace workspace_for(
    ...
    Workspace result{};
    EXPECT_EQ(marc_lzss_contextual_blocked_huffman_workspace_requirements(
...
class LzssContextualBlockedHuffmanFuzzRegression : public testing::Test {
protected:
    ...
    void expect_private_atomic_failure(
        ...
        const marc::frame::internal::
            LzssContextualBlockedHuffmanFrameValidationContext context{
                stream, limits, 0, 0};
    ...
    void expect_public_atomic_failure(
        ...
        ASSERT_EQ(marc_lzss_contextual_blocked_huffman_create(
                      &decode_config_,
...
private:
    marc_lzss_contextual_blocked_huffman_config decode_config_{};
...
TEST_F(LzssContextualBlockedHuffmanFuzzRegression,
...
TEST_F(LzssContextualBlockedHuffmanFuzzRegression,
    ...
    auto encoded = canonical_stream();
    constexpr auto descriptor_flags = marc::frame::internal::
        lzss_contextual_blocked_huffman_stream_header_size
        + marc::frame::internal::
            lzss_contextual_blocked_huffman_frame_header_size
        + 15;
