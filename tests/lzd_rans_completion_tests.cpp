...
// Reuse the LZD public-ABI admission matrix with only the rANS block ceiling,
...
#define marc_lzd_adaptive_huffman_config marc_lzd_rans_config
#define marc_lzd_adaptive_huffman_config_init marc_lzd_rans_config_init
#define marc_lzd_adaptive_huffman_workspace_requirements \
    marc_lzd_rans_workspace_requirements
#define marc_lzd_adaptive_huffman_create marc_lzd_rans_create
#define LzdAdaptiveHuffmanCompletion LzdRansCompletion
