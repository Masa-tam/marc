...
TEST(Lz78TansProfile, BuildsCanonicalDefaultAndWorstCaseWorkspace) {
    StreamHeader stream{};
    Lz78TansEncoderWorkspaceRequirements workspace{};
    ASSERT_EQ(make_lz78_tans_profile(
                  {2'500'000}, {}, stream, workspace),
              Lz78TansProfileError::none);
    ...
    EXPECT_EQ(workspace.frame_encoded_bytes, 790'728U);
...
TEST(Lz78TansProfile, HonorsShortFrameFreezeAndEmptyStream) {
    StreamHeader stream{};
    Lz78TansEncoderWorkspaceRequirements workspace{};
    Lz78TansProfileConfig short_config{17};
    short_config.parameters.maximum_entries = 2;
    ASSERT_EQ(make_lz78_tans_profile(
                  short_config, {}, stream, workspace),
              Lz78TansProfileError::none);
    EXPECT_EQ(workspace.frame_input_bytes, 17U);
    EXPECT_EQ(workspace.dictionary_staging_bytes, 136U);
    EXPECT_EQ(workspace.frame_encoded_bytes, 790U);
    EXPECT_EQ(workspace.encoder_entry_count, 2U);

    workspace = {1, 1, 1, 1, 1, 8};
    ASSERT_EQ(make_lz78_tans_profile({}, {}, stream, workspace),
              Lz78TansProfileError::none);
...
TEST(Lz78TansProfile, EnforcesBlockPayloadAggregateAndFrameLimits) {
    StreamHeader stream{};
    Lz78TansEncoderWorkspaceRequirements workspace{};
    auto limits = marc::core::DecoderLimits{};
    limits.max_blocks_per_frame = 1;
    EXPECT_EQ(make_lz78_tans_profile(
                  {2, 2, 8, {}}, limits, stream, workspace),
              Lz78TansProfileError::limit_exceeded);

    limits = {};
    limits.max_compressed_payload_size = 205;
    EXPECT_EQ(make_lz78_tans_profile(
    ...
    Lz78TansProfileConfig invalid{};
    invalid.parameters.maximum_entries = 0;
    EXPECT_EQ(make_lz78_tans_profile(invalid, {}, stream, workspace),
              Lz78TansProfileError::invalid_configuration);
}

TEST(Lz78TansProfile, CalculatesDecoderLayoutFromLocalLimits) {
    auto limits = marc::core::DecoderLimits{};
    ...
    Lz78TansDecoderWorkspaceRequirements workspace{};
    ASSERT_EQ(calculate_lz78_tans_decoder_workspace(limits, workspace),
              Lz78TansProfileError::none);
    ...
    EXPECT_EQ(workspace.views_bytes,
              workspace.phrase_offset
                  + workspace.phrase_entry_count
                        * sizeof(
                            marc::dictionary::internal::Lz78PhraseEntry));

    limits.max_internal_buffered_bytes =
        std::numeric_limits<std::uint64_t>::max();
    EXPECT_EQ(calculate_lz78_tans_decoder_workspace(limits, workspace),
              Lz78TansProfileError::arithmetic_overflow);
    EXPECT_EQ(workspace.frame_encoded_bytes, 0U);
}

TEST(Lz78TansProfile, PartitionsEncoderAndDecoderOpaqueStorage) {
    StreamHeader stream{};
    Lz78TansEncoderWorkspaceRequirements encoder{};
    ASSERT_EQ(make_lz78_tans_profile(
                  {4, 4, 32, {}}, {}, stream, encoder),
              Lz78TansProfileError::none);
    ...
    Lz78TansEncoderViews encoder_views{};
    ASSERT_EQ(partition_lz78_tans_encoder_views(
    ...
    EXPECT_EQ(partition_lz78_tans_encoder_views(
                  encoder,
                  encoder_storage.first(encoder_storage.size() - 1),
                  encoder_views),
              Lz78TansWorkspaceError::too_small);
    ...
    limits.max_blocks_per_frame = 4;
    limits.max_dictionary_entries = 10;
    Lz78TansDecoderWorkspaceRequirements decoder{};
    ASSERT_EQ(calculate_lz78_tans_decoder_workspace(limits, decoder),
              Lz78TansProfileError::none);
    ...
    Lz78TansDecoderViews decoder_views{};
    ASSERT_EQ(partition_lz78_tans_decoder_views(
    ...
    EXPECT_EQ(partition_lz78_tans_decoder_views(
...
TEST(Lz78TansProfile, MapsStableCoreErrors) {
    EXPECT_EQ(lz78_tans_profile_error_code(Lz78TansProfileError::none),
              marc::core::ErrorCode::none);
    EXPECT_EQ(lz78_tans_profile_error_code(
                  Lz78TansProfileError::invalid_configuration),
              marc::core::ErrorCode::invalid_argument);
    EXPECT_EQ(lz78_tans_profile_error_code(Lz78TansProfileError::unsupported),
...
TEST(Lz78TansProfile, RequirementsConstructStreamingRoundTrip) {
    ...
    const Lz78TansProfileConfig config{raw.size(), 2, 5, {}};
    StreamHeader stream{};
    Lz78TansEncoderWorkspaceRequirements encoder_ws{};
    ASSERT_EQ(make_lz78_tans_profile(
    ...
    Lz78TansEncoderViews encode_views{};
    ASSERT_EQ(partition_lz78_tans_encoder_views(
                  encoder_ws, encode_views_storage, encode_views),
              Lz78TansWorkspaceError::none);
    Lz78TansFrameStreamingEncoder encoder{
    ...
    Lz78TansDecoderWorkspaceRequirements decoder_ws{};
    ASSERT_EQ(calculate_lz78_tans_decoder_workspace(limits, decoder_ws),
              Lz78TansProfileError::none);
    ...
    Lz78TansDecoderViews decode_views{};
    ASSERT_EQ(partition_lz78_tans_decoder_views(
                  decoder_ws, decode_views_storage, decode_views),
              Lz78TansWorkspaceError::none);
    Lz78TansFrameStreamingDecoder decoder{
