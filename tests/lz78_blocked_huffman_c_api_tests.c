...
int main(void) {
    ...
    assert(marc_lz78_blocked_huffman_config_init(
    ...
    config.max_compressed_payload_size = 16;
    ...
    assert(marc_lz78_blocked_huffman_workspace_requirements(
               &config, &needed)
           == MARC_STATUS_OK);
    ...
    assert(marc_lz78_blocked_huffman_create(
