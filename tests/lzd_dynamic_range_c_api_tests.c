...
static void set_small_limits(marc_lzd_dynamic_range_config* config) {
...
int main(void) {
    ...
    assert(marc_lzd_dynamic_range_config_init(
    ...
    assert(marc_lzd_dynamic_range_workspace_requirements(
               &config, &needed)
           == MARC_STATUS_OK);
    ...
    assert(marc_lzd_dynamic_range_create(
