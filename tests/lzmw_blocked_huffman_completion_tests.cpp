...
namespace lzmw_blocked_huffman_completion {
...
marc_lzmw_blocked_huffman_config config(
    ...
    marc_lzmw_blocked_huffman_config result{};
    EXPECT_EQ(marc_lzmw_blocked_huffman_config_init(direction, &result),
              MARC_STATUS_OK);
...
Workspace workspace_for(
    const marc_lzmw_blocked_huffman_config& settings) {
    Workspace result{};
    EXPECT_EQ(marc_lzmw_blocked_huffman_workspace_requirements(
...
Transform create(const marc_lzmw_blocked_huffman_config& settings,
                 Workspace& workspace) {
    marc_transform* raw{};
    EXPECT_EQ(marc_lzmw_blocked_huffman_create(
                  &settings,
...
TEST(LzmwBlockedHuffmanCompletion,
...
TEST(LzmwBlockedHuffmanCompletion, MultiFrameStreamIsIndependentOfChunking) {
...
TEST(LzmwBlockedHuffmanCompletion, MalformedFinalFrameIsNeverCommitted) {
