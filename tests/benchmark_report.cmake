...
if(BENCHMARK_HAS_64M)
    set(selected_4m "${BENCHMARK_PROFILE_BASE}-4m")
    set(selected_16m "${BENCHMARK_PROFILE_BASE}-16m")
    set(selected_64m "${BENCHMARK_PROFILE_BASE}-64m")
    set(profile_sequence
        "${BENCHMARK_PROFILE_BASE}, ${selected_1m}, ${selected_4m}, ${selected_16m}, ${selected_64m},")
    set(near_miss "${BENCHMARK_PROFILE_BASE}-64M")
    set(expected_base_count 5)
elseif(BENCHMARK_HAS_16M)
    set(selected_4m "${BENCHMARK_PROFILE_BASE}-4m")
    set(selected_16m "${BENCHMARK_PROFILE_BASE}-16m")
    set(profile_sequence
