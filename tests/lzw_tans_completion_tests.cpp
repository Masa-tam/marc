...
// Reuse the LZW public-ABI admission matrix with only the tANS block ceiling,
...
#define marc_lzw_adaptive_huffman_config marc_lzw_tans_config
#define marc_lzw_adaptive_huffman_config_init marc_lzw_tans_config_init
#define marc_lzw_adaptive_huffman_workspace_requirements \
    marc_lzw_tans_workspace_requirements
#define marc_lzw_adaptive_huffman_create marc_lzw_tans_create
#define LzwAdaptiveHuffmanCompletion LzwTansCompletion
