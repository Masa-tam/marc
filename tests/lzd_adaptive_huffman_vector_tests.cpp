...
constexpr std::array<std::byte, 77> complete_frame{
...
TEST(LzdAdaptiveHuffmanVector, EmitsIndependentTerminalTokenFrame) {
    ...
    EXPECT_EQ(entropy.payload_bits, 37U);
