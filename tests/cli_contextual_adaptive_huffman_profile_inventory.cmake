...
string(REGEX MATCHALL "lzss-contextual-adaptive-huffman-16m"
    sixteen_mib_matches "${usage_text}")
...
execute_process(
    COMMAND "${MARC_CLI}" encode
        --codec lzss-contextual-adaptive-huffman-16M
...
if(NOT sixteen_mib_near_miss_result EQUAL 2)
    message(FATAL_ERROR
        "CLI accepted a near-miss sixteen-MiB Contextual Adaptive Huffman profile")
endif()
