...
TEST(DynamicRangeFrameStreamingEncoder, MatchesOracleWithOneByteBuffers) {
    const auto expected = reference_encode();
    std::array<std::byte, 4> frame_input{};
    std::array<std::byte, 256> frame_encoded{};
    marc::frame::DynamicRangeFrameStreamingEncoder encoder{
...
TEST(DynamicRangeFrameStreamingEncoder, EmitsFullFrameBeforeEndInput) {
    const auto expected = reference_encode();
    std::array<std::byte, 4> frame_input{};
    std::array<std::byte, 256> frame_encoded{};
    marc::frame::DynamicRangeFrameStreamingEncoder encoder{
...
TEST(DynamicRangeFrameStreamingEncoder, FlushKeepsPartialFrameOpen) {
    const auto expected = reference_encode();
    std::array<std::byte, 4> frame_input{};
    std::array<std::byte, 256> frame_encoded{};
    marc::frame::DynamicRangeFrameStreamingEncoder encoder{
...
TEST(DynamicRangeFrameStreamingEncoder, ReportsShortFrameWorkspace) {
    std::array<std::byte, 4> frame_input{};
...
TEST(DynamicRangeFrameStreamingEncoder, PreservesPlanningLimitCategory) {
    std::array<std::byte, 4> frame_input{};
    std::array<std::byte, 256> frame_encoded{};
...
TEST(DynamicRangeFrameStreamingEncoder, HandlesEmptyAndRejectsPrematureEnd) {
    std::array<std::byte, 1> unused{};
    std::array<std::byte, marc::frame::stream_header_size> output{};
    marc::frame::DynamicRangeFrameStreamingEncoder empty{
