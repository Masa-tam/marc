...
[[nodiscard]] std::vector<std::byte> reference() {
    ...
    std::vector<std::byte> output(lzw_dynamic_range_stream_prefix_size);
...
TEST(LzwDynamicRangeFrameStreamingEncoder, MatchesOneByteReference) {
    const auto expected = reference();
    std::array<std::byte, 2> frame_input{};
    std::array<std::byte, 4> staging{};
    std::array<std::byte, 2048> frame_encoded{};
    std::array<marc::dictionary::internal::LzwEncoderEntry, 1> entries{};
    LzwDynamicRangeFrameStreamingEncoder encoder{
...
TEST(LzwDynamicRangeFrameStreamingEncoder,
     FlushKeepsFramesCanonicalAndStreamOpen) {
    const auto expected = reference();
    std::array<std::byte, 2> frame_input{};
    std::array<std::byte, 4> staging{};
    std::array<std::byte, 2048> frame_encoded{};
    ...
    EXPECT_EQ(first.output_produced, lzw_dynamic_range_stream_prefix_size);
...
TEST(LzwDynamicRangeFrameStreamingEncoder,
     RetainsEndInputWhileDrainingPrefix) {
    const auto expected = reference();
    std::array<std::byte, 2> frame_input{};
    std::array<std::byte, 4> staging{};
    std::array<std::byte, 2048> frame_encoded{};
...
TEST(LzwDynamicRangeFrameStreamingEncoder, EnforcesAllStorageBounds) {
    std::array<std::byte, 2> frame_input{};
    std::array<std::byte, 4> staging{};
    std::array<std::byte, 2048> frame_encoded{};
    std::array<marc::dictionary::internal::LzwEncoderEntry, 1> entries{};
    ...
    LzwDynamicRangeFrameStreamingEncoder short_input{
        config(input.size()), {}, {},
    ...
    LzwDynamicRangeFrameStreamingEncoder short_dictionary{
        config(input.size()), {}, {}, frame_input,
        std::span<std::byte>{staging}.first<3>(), frame_encoded, entries};
    EXPECT_EQ(short_dictionary.process({}, {}, 0).error.code,
              marc::core::ErrorCode::out_of_memory);
    LzwDynamicRangeFrameStreamingEncoder short_entries{
        config(input.size()), {}, {}, frame_input, staging, frame_encoded, {}};
    EXPECT_EQ(short_entries.process({}, {}, 0).error.code,
              marc::core::ErrorCode::out_of_memory);

    LzwDynamicRangeFrameStreamingEncoder short_encoded{
    ...
    limits.max_internal_buffered_bytes = 2 + plan.dictionary_size
        ...
        - 1;
    LzwDynamicRangeFrameStreamingEncoder aggregate_limited{
...
TEST(LzwDynamicRangeFrameStreamingEncoder, HandlesEmptyAndProtocolErrors) {
    std::array<std::byte, 1> unused{};
    std::array<std::byte, lzw_dynamic_range_stream_prefix_size> output{};
    LzwDynamicRangeFrameStreamingEncoder empty{
        config(0), {}, {}, {}, {}, unused, {}};
    auto result = empty.process(
        {}, output,
        marc::core::flag_value(marc::core::ProcessFlags::end_input));
    EXPECT_EQ(result.status, marc::core::StreamStatus::end_of_stream);
    EXPECT_EQ(result.output_produced, lzw_dynamic_range_stream_prefix_size);
    ...
    std::array<std::byte, 2048> frame_encoded{};
    std::array<marc::dictionary::internal::LzwEncoderEntry, 1> entries{};
    LzwDynamicRangeFrameStreamingEncoder premature{
        config(input.size()), {}, {}, frame_input, staging, frame_encoded,
        entries};
    ...
    LzwDynamicRangeFrameStreamingEncoder excess{
        config(1), {}, {}, frame_input, staging, frame_encoded, entries};
    result = excess.process(input, {}, 0);
    EXPECT_EQ(result.error.code, marc::core::ErrorCode::invalid_argument);

    LzwDynamicRangeFrameStreamingEncoder reset{
        config(input.size()), {}, {}, frame_input, staging, frame_encoded,
        entries};
    ...
    LzwDynamicRangeFrameStreamingEncoder unknown{
        config(input.size()), {}, {}, frame_input, staging, frame_encoded,
        entries};
