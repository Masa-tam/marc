...
static void set_small_limits(marc_lzd_adaptive_huffman_config* config) {
...
int main(void) {
    ...
    assert(marc_lzd_adaptive_huffman_config_init(
    ...
    assert(marc_lzd_adaptive_huffman_workspace_requirements(
               &config, &needed)
           == MARC_STATUS_OK);
    ...
    assert(marc_lzd_adaptive_huffman_create(
