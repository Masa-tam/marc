...
TEST(Lz77AdaptiveHuffmanFrameStreamingDecoder, DecodesOneByteInputAndOutput) {
    const auto encoded = encoded_stream();
    std::array<std::byte, 2048> frame_encoded{};
    std::array<std::byte, 32> dictionary_staging{};
    std::array<std::byte, 2> frame_decoded{};
    Lz77AdaptiveHuffmanFrameStreamingDecoder decoder{
...
TEST(Lz77AdaptiveHuffmanFrameStreamingDecoder, CommitsOnlyFramesBeforeLaterCorruption) {
    auto encoded = encoded_stream();
    const auto first_size = frame_size_at(
        encoded, lz77_adaptive_huffman_stream_prefix_size);
    const auto second_offset =
        lz77_adaptive_huffman_stream_prefix_size + first_size;
...
TEST(Lz77AdaptiveHuffmanFrameStreamingDecoder, ReportsWorkspaceAndAggregateErrors) {
    const auto encoded = encoded_stream();
    const auto first_size = frame_size_at(
        encoded, lz77_adaptive_huffman_stream_prefix_size);
    std::array<std::byte, 2048> frame_encoded{};
    ...
    Lz77AdaptiveHuffmanFrameStreamingDecoder short_encoded{
    ...
    Lz77AdaptiveHuffmanFrameStreamingDecoder short_dictionary{
        {}, frame_encoded,
    ...
    Lz77AdaptiveHuffmanFrameStreamingDecoder short_decoded{
    ...
    Lz77AdaptiveHuffmanFrameStreamingDecoder aggregate_limited{
...
TEST(Lz77AdaptiveHuffmanFrameStreamingDecoder, RejectsTruncationTrailingAndReset) {
    const auto encoded = encoded_stream();
    std::array<std::byte, 2048> frame_encoded{};
    std::array<std::byte, 32> dictionary_staging{};
    std::array<std::byte, 2> frame_decoded{};
    ...
    Lz77AdaptiveHuffmanFrameStreamingDecoder truncated{
        {}, frame_encoded, dictionary_staging, frame_decoded};
    ...
    Lz77AdaptiveHuffmanFrameStreamingDecoder trailing{
        {}, frame_encoded, dictionary_staging, frame_decoded};
    EXPECT_EQ(trailing.process(extended, output, end).error.code,
              marc::core::ErrorCode::malformed_stream);

    Lz77AdaptiveHuffmanFrameStreamingDecoder reset{
        {}, frame_encoded, dictionary_staging, frame_decoded};
...
TEST(Lz77AdaptiveHuffmanFrameStreamingDecoder, HandlesEmptyFlushAndPrematureEnd) {
    const auto empty_encoded = encoded_stream({});
    Lz77AdaptiveHuffmanFrameStreamingDecoder empty{{}, {}, {}, {}};
    ...
    std::array<std::byte, 32> dictionary_staging{};
    std::array<std::byte, 2> frame_decoded{};
    Lz77AdaptiveHuffmanFrameStreamingDecoder starved{
        {}, frame_encoded, dictionary_staging, frame_decoded};
    ...
    const auto prefix_and_first_frame =
        lz77_adaptive_huffman_stream_prefix_size + first_size;
    Lz77AdaptiveHuffmanFrameStreamingDecoder premature{
        {}, frame_encoded, dictionary_staging, frame_decoded};
    std::array<std::byte, 1> output{};
