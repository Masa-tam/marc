...
The seventeen bounded targets cover standalone LZ77, LZSS, LZ78, LZW, LZD,
...
Blocked Huffman, LZW plus Blocked Huffman, LZD plus Blocked Huffman, and
checksum-raw profiles. Targets
