...
Dynamic Range identity `3/2` now admits the lifecycle for exact triple
...
history. The public C selector `MARC_LZSS_CONTEXTUAL_PROFILE_64M` has value 4
and admits this triple only through the Contextual Dynamic Range factory. Its
