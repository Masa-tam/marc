...
publication: schema 11 includes all current published profiles while
...
visible decoder or encoder, C factory, CLI selector, benchmark, fuzz boundary,
or interoperability entry is claimed yet.
