...
| `lzd-blocked-huffman` | Yes | Yes | Yes | No | No | Yes | Yes | Not included |
...
|---|---|---|
| LZD plus Blocked Huffman | Exact format, complete-frame codec, checked profile layout, bounded streaming transforms, public C factory, completion matrix, and bounded decoder fuzz target | Core library evidence admitted; CLI, benchmark, and interoperability pending |
