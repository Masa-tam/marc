...
|---|---|---|
| LZW plus Blocked Huffman | Transactional frame boundary plus checked worst-case sizing and typed workspace partition | Specified; streaming and public profile pending |
...
At DD-237, the complete Release suite contains 1079 tests and passes under both
