...
| `lzw-blocked-huffman` | Fourth composed dictionary/entropy pipeline | C ABI admitted; remaining evidence pending | Not included |
...
| `lzw-blocked-huffman` | Yes | Yes | Yes | No | No | No | No | Not included |
...
|---|---|---|
| LZW plus Blocked Huffman | Public C factory and workspace query over the complete internal streaming profile | Admitted; completion and tooling pending |
...
At DD-239, the complete Release suite contains 1086 tests and passes under both
