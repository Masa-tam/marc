...
| `lzmw-blocked-huffman` | Yes | Yes | Yes | No | No | Yes | Yes | No |
...
|---|---|---|
| LZMW plus Blocked Huffman | Exact format, complete-frame codec, opaque workspace profile, bounded frame-transactional streaming, public C ABI, completion matrix, and bounded decoder fuzzing | CLI, benchmark, and interoperability pending |
