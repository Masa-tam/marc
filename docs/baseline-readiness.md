...
|---|---|---|
| LZMW plus Blocked Huffman | Exact format, complete-frame codec, checked opaque encoder/decoder workspace partition, and transactional publication | Frame codec and profile layout complete; streaming pending |
