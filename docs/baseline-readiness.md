...
| `lzw-adaptive-huffman` | Fourth Adaptive Huffman composition | CLI published | Not yet included |
...
| `lzw-adaptive-huffman` | Yes | Yes | Yes | Yes | No | Yes | Yes | Not included |
...
It remains below `Ready` until benchmark and interoperability coverage are
added.
...
At DD-327, the complete Release suite contains 1,343 tests and passes under both
