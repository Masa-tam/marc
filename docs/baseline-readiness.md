...
| `lz77-adaptive-huffman` | Yes | Yes | Yes | No | No | Yes | Yes | No |
...
Its CLI selector, benchmark adapter, and interoperability schema entry remain
in the local admission queue. Candidate
...
At DD-285, the complete Release suite contains 1,206 tests and passes under both
