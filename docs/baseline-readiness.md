...
| `lzmw-blocked-huffman` | Yes | Yes | Yes | Yes | No | Yes | Yes | No |
...
|---|---|---|
| LZMW plus Blocked Huffman | Exact format, complete-frame codec, opaque workspace profile, bounded frame-transactional streaming, public C ABI, completion matrix, bounded decoder fuzzing, and transactional CLI | Benchmark and interoperability pending |
